...
echo form_open('ehr_utilities/util_edit_state_info/'.$form_purpose.'/'.$addr_state_id, $attributes);
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='110'>";
	echo anchor('ehr_utilities/util_list_addrdistricts/addr_district_code', 'Code');
    echo "</th>";
    echo "\n<th width='300'>";
	echo anchor('ehr_utilities/util_list_addrdistricts/addr_district_name', 'District Name');
    echo "</th>";
    echo "\n<th width='200'>";
	echo anchor('ehr_utilities/util_list_addrdistricts/addr_state_name', 'State');
    echo "</th>";
    echo "\n<th width='50'>Sort</th>";
...
if(isset($district_list)){
    ...
    foreach ($district_list as $district_item){
        ...
        echo "\n<td>".anchor('ehr_utilities/util_edit_district_info/edit_district/'.$district_item['addr_district_id'], "<strong>".$district_item['addr_district_name']."</strong>")."</td>";
