...
echo anchor('ehr_orders/orders_edit_imagsupplier_info/new_supplier/imag/new_supplier', "<strong>Add New Supplier</strong>");
echo "\n<br /><br />";
...
if(isset($supplier_list)){
    ...
    foreach ($supplier_list as $supplier_item){
        ...
        echo "\n<td>".anchor('ehr_orders/orders_edit_imagsupplier_info/edit_supplier/imag/'.$supplier_item['supplier_id'], "<strong>".$supplier_item['supplier_name']."</strong>")."</td>";
