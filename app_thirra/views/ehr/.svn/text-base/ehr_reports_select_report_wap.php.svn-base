...
echo "\n<input type='radio' name='output_format' value='csv' ".set_radio('output_format','csv',($output_format=='csv'?TRUE:FALSE))." disabled='disabled'>CSV</input>";
echo "\n</td></tr>";

echo "\n<tr><td>Period From</td><td>";
echo form_error('period_from');
echo "<input type='text' name='period_from' value='".set_value('period_from',$period_from)."' size='10' /> YYYY-MM-DD</td></tr>";

echo "\n<tr><td>Period To</td><td>";
echo form_error('period_to');
echo "<input type='text' name='period_to' value='".set_value('period_to',$period_to)."' size='10' /> YYYY-MM-DD</td></tr>";
