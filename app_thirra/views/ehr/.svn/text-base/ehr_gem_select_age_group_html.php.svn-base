...
echo form_open('ehr_consult_gem/gem_edit_consult/'.$patient_id, $attributes);
...
if(isset($agebands_list)){
    ...
    foreach ($agebands_list as $ageband_item){
        ...
        echo anchor('ehr_consult_gem/gem_edit_consult/new_consult/'.$submodule_info[0]['gem_submod_id'].'/'.$ageband_item['gem_agegroup_id'].'/'.$patient_id.'/'.$summary_id, $ageband_item['gem_agename']);
        echo "</td>";
