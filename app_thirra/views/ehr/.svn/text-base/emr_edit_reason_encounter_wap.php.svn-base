...
echo "<tr>";
    ...
    echo "\n<select name='complaintChapter' class='normal' onchange='javascript:selectComplaintCategory()' id='complaintChapter'>";
...
echo "\n<tr>";
    ...
    echo "\n<td colspan='2' class='red'>";
        echo "\n<select name='complaintCode' class='normal' onchange='javascript:selectDiagnosis()' id='complaintCode'>";
