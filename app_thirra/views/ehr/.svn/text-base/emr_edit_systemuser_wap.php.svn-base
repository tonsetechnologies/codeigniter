...
echo "<input type='password' name='password1' value='".set_value('password1',$password1)."' size='15' /></td></tr>";

echo "\n<tr><td>Repeat Password</td><td>";
echo form_error('password2');
echo "<input type='password' name='password2' value='".set_value('password2',$password2)."' size='15' /></td></tr>";
...
echo "<input type='text' name='expiry_date' value='".set_value('expiry_date',$expiry_date)."' size='10' /></td></tr>";
/*
...
echo "<input type='text' name='staff_name' value='".set_value('staff_name',$staff_name)."' size='25' /></td></tr>";

echo "\n<tr><td>Staff Initials <font color='red'>*</font></td><td>";
echo form_error('staff_initials');
echo "\n<input type='text' name='staff_initials' value='".set_value('staff_initials',$staff_initials)."' size='5' /></td></tr>";
...
echo form_error('specialty');
    ...
    echo "\n<option value='Specialist-Paediatrics' ".($specialty=='Specialist'?' selected=\'selected\'':'').">Specialist-Paediatrics</option>";
    echo "\n<option value='Specialist-Surgery' ".($specialty=='Specialist'?' selected=\'selected\'':'').">Specialist-Surgery</option>";
    echo "\n</select>";
echo "</td></tr>\n";
...
echo "\n<input type='text' name='ic_no' value='".set_value('ic_no',$ic_no)."' size='10' /></td></tr>";

echo "\n<tr><td>Other IC Type</td><td>";
echo form_error('ic_other_type');
echo "\n<input type='text' name='ic_other_type' value='".set_value('ic_other_type',$ic_other_type)."' size='10' /></td></tr>";

echo "\n<tr><td>Other IC No.</td><td>";
echo form_error('ic_other_no');
echo "\n<input type='text' name='ic_other_no' value='".set_value('ic_other_no',$ic_other_no)."' size='10' /></td></tr>";
...
echo "\n<input type='text' name='date_of_birth' value='".set_value('date_of_birth',$date_of_birth)."' size='10' /></td></tr>";

echo "\n<tr><td>Race</td><td>";
echo form_error('race');
echo "\n<input type='text' name='race' value='".set_value('race',$race)."' size='10' /></td></tr>";
...
echo "\n<input type='text' name='town' value='".set_value('town',$town)."' size='20' /></td></tr>";

echo "\n<tr><td>State</td><td>";
echo form_error('state');
echo "\n<input type='text' name='state' value='".set_value('state',$state)."' size='20' /></td></tr>";
...
echo "\n<input type='text' name='email' value='".set_value('email',$email)."' size='20' /></td></tr>";
