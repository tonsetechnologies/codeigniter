...
echo "\n\n<div id='pharmacy_prescriptions' class='section'>";
	...
	echo "\n<div class='section_body'>";
        ...
        foreach ($prescription_info as $prescription_item){
            ...
            echo "<td>";
            echo anchor('ehr_pharmacy/phar_close_prescription/'.$prescription_item['patient_id'].'/'.$prescription_item['session_id'], 'Archive');
            echo "</td>";
            echo "</tr>";
        }//endforeach;
        echo "\n</table>";
...
echo "\n\n<div id='pharmacy_' class='section'>";
	...
	echo "\n<div class='section_body'>";
    echo anchor('ehr_pharmacy/phar_listclosed_prescriptions/', 'Prescriptions');
	echo "\n<br />Dispensing";
	echo "<br />";
	echo "</div>";
	echo "<br />";
...
echo "\n\n<div id='pharmacy_inventory' class='section'>";
	...
	echo "\n<div class='section_body'>";
    echo anchor('ehr_pharmacy_supplier/phar_list_drug_suppliers/drug', 'Drug Suppliers');
	echo "<br />";
    echo anchor('ehr_pharmacy/phar_list_drug_packages', 'Drug Packages');
	echo "<br />";
	echo "</div>";
	echo "<br />";
echo "</div>";
