...
echo "\n<tr>";
    ...
    echo anchor('ehr_individual_refer/draft_notify_email/new_draft/'.$patient_id.'/'.$summary_id.'/'.$referral_id, 'Send email',"target='_blank'");
...
echo "\n<tr>";
    ...
    if(!empty($thirra_url)){
        ...
        echo form_open('ehr_individual_refer/check_remote_patient_existence/check_patient/'.$patient_id.'/'.$summary_id.'/'.$referral_id);
...
echo "\n<tr>";
    ...
    echo anchor('ehr_individual_refer/refer_select_details/new_export/'.$patient_id.'/'.$summary_id.'/'.$referral_id, 'Export XML', 'target="_blank"')."</td>";
echo "</tr>";
echo "\n<tr>";
    echo "\n<td>Print Referral Letter</td>";
    echo "\n<td valign='top'>";
    echo "\nGeneric : ";
    echo anchor('ehr_individual_refer/print_referral_letter/Gen/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/html', 'HTML', 'target="_blank"');
    echo ", ";
    echo anchor('ehr_individual_refer/print_referral_letter/Gen/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/pdf', 'PDF', 'target="_blank"');
    echo "\n<br />MY : ";
    echo anchor('ehr_individual_refer/print_referral_letter/MY/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/html', 'HTML', 'target="_blank"');
    echo ", ";
    echo anchor('ehr_individual_refer/print_referral_letter/MY/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/pdf', 'PDF', 'target="_blank"');
    echo "\n<br />NP : ";
    echo anchor('ehr_individual_refer/print_referral_letter/NP/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/html', 'HTML', 'target="_blank"');
    echo ", ";
    echo anchor('ehr_individual_refer/print_referral_letter/NP/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/pdf', 'PDF', 'target="_blank"');
    echo "\n<br />PH : ";
    echo anchor('ehr_individual_refer/print_referral_letter/PH/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/html', 'HTML', 'target="_blank"');
    echo ", ";
    echo anchor('ehr_individual_refer/print_referral_letter/PH/'.$patient_id.'/'.$summary_id.'/'.$referral_id.'/pdf', 'PDF', 'target="_blank"');
echo "</tr>";
echo "\n</table>";
echo "</fieldset>";


echo form_open('ehr_individual_refer/edit_referral_out/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$referral_id);
