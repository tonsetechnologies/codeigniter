...
echo anchor('ehr_individual/edit_drug_allergy/new_allergy/'.$patient_id.'/new_allergy', "<strong>Add New Allergy</strong>");
echo "\n<br /><br />";
...
if(isset($allergy_list)){
    ...
    foreach ($allergy_list as $allergy_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual/edit_drug_allergy/edit_allergy/'.$patient_id.'/'.$allergy_item['patient_drug_allergy_id'], $allergy_item['generic_name']."</td>");
