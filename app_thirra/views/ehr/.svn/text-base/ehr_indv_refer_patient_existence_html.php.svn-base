...
foreach($xml_array['exact_match'] as $exact_match){
    echo form_open('ehr_individual_refer/send_referral_out2server_confirm/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$referral_id);
    echo "\n<tr>";
...
echo "\n<table>";
echo "\n<tr>";
    echo "<td valign='top'>".anchor('ehr_individual_refer/refer_select_details/new_export/'.$patient_id.'/'.$summary_id.'/'.$referral_id, 'Export XML', 'target="_blank"')."</td>";
echo "</tr>";
echo "\n<tr>";
    echo "<td valign='top'>".anchor('ehr_consult/print_referral_letter/print_referral_letter/'.$patient_id.'/'.$summary_id.'/'.$referral_id, 'Print', 'target="_blank"')."</td>";
echo "</tr>";
echo "\n</table>";
