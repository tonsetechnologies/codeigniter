...
if(isset($history_list)){
    ...
    foreach ($history_list as $history_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual_antenatal/edit_history_antenatal/'.$patient_id.'/edit_antenatal/'.$history_item['antenatal_id'], "<strong>".$history_item['date']."</strong>")."</td>";
...
echo form_open('ehr_individual_antenatal/edit_history_antenatal/'.$patient_id.'/'.$form_purpose.'/'.$antenatal_id);
...
if($antenatal_id == "new_antenatal"){
    ...
    if($history_info[0]['status'] == 0){
        echo "<input type='submit' value='Add/Edit History' />";
        echo "<br /><br /><br />";
        $status_link    =   base_url()."index.php/ehr_individual_antenatal/status_history_antenatal/close/".$patient_id."/".$antenatal_id."/".$antenatal_info_id."/".$antenatal_current_id;
        echo "\n<a href=\"javascript:deleteRecord('close','Pregnancy event','".$status_link ."');\">Close to editing</a>";
    } else {
        echo "[ View Only]";
        $status_link    =   base_url()."index.php/ehr_individual_antenatal/status_history_antenatal/reopen/".$patient_id."/".$antenatal_id."/".$antenatal_info_id."/".$antenatal_current_id;
...
if(isset($followup_list)){
    ...
    foreach ($followup_list as $followup_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual_antenatal/edit_history_antenatal_followup/edit_followup/'.$patient_id.'/'.$followup_item['antenatal_id'].'/'.$followup_item['antenatal_followup_id'], "<strong>".$followup_item['date']."</strong>")."</td>";
...
if($antenatal_id <> "new_antenatal"){
    echo anchor('ehr_individual_antenatal/edit_history_antenatal_delivery/new_delivery/'.$patient_id.'/'.$antenatal_id.'/new_delivery', "<strong>Add New Delivery</strong>");
} else {
...
if(isset($delivery_list)){
    ...
    foreach ($delivery_list as $delivery_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual_antenatal/edit_history_antenatal_delivery/edit_delivery/'.$patient_id.'/'.$antenatal_id.'/'.$delivery_item['antenatal_delivery_id'], "<strong>".$delivery_item['date_delivery']."</strong>")."</td>";
...
if(isset($postpartum_list)){
    ...
    foreach ($postpartum_list as $postpartum_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual_antenatal/edit_history_antenatal_postpartum/edit_postpartum/'.$patient_id.'/'.$postpartum_item['session_id'].'/'.$antenatal_id.'/'.$postpartum_item['antenatal_postpartum_id'], "<strong>".$postpartum_item['care_date']."</strong>")."</td>";
