...
echo form_open('ehr_individual/edit_patient/'.$form_purpose.'/'.$patient_id, $attributes);
...
if(isset($duplicate_patient)){
    ...
    echo "\n<table>";
        ...
        foreach($duplicate_patient as $others){
	        ...
	        echo anchor('ehr_individual/individual_overview/'.$others['patient_id'], "<strong>".$others['name']."</strong>, ".$others['name_first']." (".$others['birth_date'].") ", 'target="_blank"');
...
/*
        ...
        function selectHeadOfFamily(){
            $("patient_form").status.value="Unfinished";
        ...
        window.onload = function () {
            ...
            $("expand").onclick = selectHeadOfFamily;
