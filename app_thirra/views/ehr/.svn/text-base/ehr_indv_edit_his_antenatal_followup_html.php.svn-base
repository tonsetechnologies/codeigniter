...
if(isset($followup_list)){
    ...
    foreach ($followup_list as $followup_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual_antenatal/edit_history_antenatal/'.$patient_id.'/edit_history/'.$followup_item['antenatal_id'], "<strong>".$followup_item['date']."</strong>")."</td>";
...
echo form_open('ehr_individual_antenatal/edit_history_antenatal_followup/'.$form_purpose.'/'.$patient_id.'/'.$antenatal_id.'/'.$antenatal_followup_id, $attributes);
echo "\n<table>";
