...
echo anchor('ehr_utilities/util_edit_diagnosis_info/new_code/new_code', "<strong>Add New Diagnosis Code</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='60'>";
	echo anchor('ehr_utilities/util_list_diagnosiscodes/commonly_used/0', 'CU');
    echo "</th>";
    echo "\n<th width='20'>";
...
if(isset($diagnosis_list)){
    ...
    for ($i=0; $i < $per_page; $i++){
        ...
        echo "\n<td valign='top'>".anchor('ehr_utilities/util_list_diagnosisext_codes/dcode1ext_code/'.$diagnosis_list[$i]['dcode1_id'], $diagnosis_list[$i]['full_title'])."</td>";
