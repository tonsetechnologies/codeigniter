...
echo form_open('ehr_consult_antenatal/edit_antenatal_postpartum/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$antenatal_id.'/'.$antenatal_postpartum_id, $attributes);
echo "\n<table>";
...
echo "\n<select class='normal' name='want_family_planning'>";          
    ...
    echo "\n<option value='Yes' ".($init_pwant_family_planning=='Yes'?"selected='selected'":"").">Yes</option>";
echo "\n</select>";
echo "\n</td>";
echo "\n</tr>";
...
echo $delivery_list[0]['baby_weight']."</td></tr>";
