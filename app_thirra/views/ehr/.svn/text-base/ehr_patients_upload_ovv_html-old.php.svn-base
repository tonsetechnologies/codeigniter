...
if($patient_id == "new_patient"){
    ...
    foreach ($files_list as $pic) {
        echo "\n<tr><td>&nbsp;</td><td>";
        echo "<a href='".$patient_pics_path."/".$pic['file_filename']."' target='_blank'>View ";
        //echo "<a href='".$pics_url."/".$pic['bio_filename'].".jpg' target='_blank'>View ";
        echo "<img src='".$patient_pics_path."/".$pic['file_filename']."_tnlo".$pic['file_extension']."' alt='image'></a> ";
