...
echo "\n<tr><td>addr_village_id</td><td>";
echo form_error('addr_village_id');
echo $init_addr_village_id."</td></tr>";

echo "\n<tr><td>addr_town_id</td><td>";
echo form_error('addr_town_id');
echo $init_addr_town_id."</td></tr>";

echo "\n<tr><td>addr_area_id</td><td>";
echo form_error('addr_area_id');
echo $init_addr_area_id."</td></tr>";

echo "\n<tr><td>addr_district_id</td><td>";
echo form_error('addr_district_id');
echo $init_addr_district_id."</td></tr>";

echo "\n<tr><td>addr_state_id</td><td>";
echo form_error('addr_state_id');
echo $init_addr_state_id."</td></tr>";
