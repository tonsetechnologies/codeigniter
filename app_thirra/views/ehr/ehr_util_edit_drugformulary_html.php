...
echo form_open('ehr_utilities/util_edit_drugformulary/'.$form_purpose.'/'.$drug_formulary_id, $attributes);
...
foreach ($drugcode_list as $drugcode_item){
    echo "\n<li>".anchor('ehr_utilities/util_edit_drugcode/edit_drugcode/'.$drugcode_item['drug_code_id'], $drugcode_item['trade_name'])."</li>";
}//endforeach;
echo "\n</ol>";
