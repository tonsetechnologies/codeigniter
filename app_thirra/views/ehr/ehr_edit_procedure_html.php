...
foreach ($lab_list as $order_item){
    echo "\n<tr>";
    echo "<td>".anchor('ehr_consult_orders/edit_lab/edit_lab/'.$patient_id.'/'.$summary_id.'/'.$order_item['lab_order_id'], $order_item['package_code'])."</td>";
    ...
    //if($order_item['details'] == "FALSE"){
        //echo anchor('ehr_consult_orders/consult_delete_lab/'.$patient_id.'/'.$summary_id.'/'.$order_item['lab_order_id'].'/'.$order_item['details'], "Delete");
        $delete_link    =   base_url()."index.php/ehr_consult_orders/consult_delete_lab/".$patient_id."/".$summary_id."/".$order_item['lab_order_id'].'/'.$order_item['details'];
...
echo form_open('ehr_consult_orders/edit_lab/'.$form_purpose.'/'.$patient_id.'/'.$lab_order_id, $attributes);
...
echo "<tr><td><b>Procedure Order</b></td></tr>";
echo "</table>";
...
if($enter_tests == TRUE){
    ...
    echo "\n<tr>";
        echo "\n<td width='25%'>Procedure <font color='red'>*</font></td>";
        echo "<td colspan='2' class='red'>";   
...
echo "\n<br />";
echo "\n<center>";
    echo "\n<input class='button' type='submit' name='submit' value='Add Lab Order' />";
echo "\n</center>";
