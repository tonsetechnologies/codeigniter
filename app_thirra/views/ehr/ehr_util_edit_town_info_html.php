...
if($addr_town_id <> "new_town"){
    echo anchor('ehr_utilities/util_edit_village_info/new_village/new_village', "<strong>Add New Village</strong>");
}
$dummy_exist    =   FALSE;
...
if(count($village_list) > 0){
    ...
    echo "\n<tr>";
        echo "\n<th>No.</th>";
        echo "\n<th width='110'>";
	    //echo anchor('ehr_utilities/util_list_addrvillages/addr_village_code', 'Code');
        echo "Code</th>";
        echo "\n<th width='300'>";
	    //echo anchor('ehr_utilities/util_list_addrvillages/addr_village_name', 'Village Name');
        echo "Village Name</th>";
        echo "\n<th width='250'>";
	    //echo anchor('ehr_utilities/util_list_addrvillages/addr_town_name', 'Town');
        echo "Town</th>";
        echo "\n<th width='250'>";
	    //echo anchor('ehr_utilities/util_list_addrvillages/addr_area_name', 'Area');
        echo "Area</th>";
        echo "\n<th width='200'>";
	    //echo anchor('ehr_utilities/util_list_addrvillages/addr_district_name', 'District');
        echo "District</th>";
        echo "\n<th width='50'>Sort</th>";
    ...
    if(isset($village_list)){
        ...
        foreach ($village_list as $village_item){
            ...
            echo "\n<td>".anchor('ehr_utilities/util_edit_village_info/edit_village/'.$village_item['addr_village_id'], "<strong>".$village_item['addr_village_name']."</strong>")."</td>";
...
if($addr_town_id <> "new_town" && $dummy_exist===FALSE){
    echo "\n<br />For urban areas - ";
    echo form_open('ehr_utilities/util_edit_village_info/new_village/new_village', $attributes);
