...
echo "\n\n<div id='patient_queue' class='section'>";
	...
	echo "\n<div class='section_body'>";
        ...
        foreach ($queue_info as $queue_item){
            ...
            echo "<td>&nbsp;".anchor('ehr_individual/individual_overview/'.trim($queue_item['patient_id']).'/'.$queue_item['booking_id'], $queue_item['name']." (".$queue_item['birth_date'].")", "target='_blank'")."</td>";
