...
echo form_open('ehr_orders/edit_labresults/edit_labresults/'.$patient_id, $attributes);
...
echo "\n<input type='text' name='result_date' value='".set_value('result_date',$result_date)."' size='10' /> YYYY-MM-DD</td></tr>";
...
if($num_of_tests > 0){
    ...
    foreach ($package_info as $test_item){
        ...
        echo "\n<td><input type='text' name='".$varname_result."' value='".set_value($varname_result,$test_item[$varname_result])."' size='20' /></td>";
        echo "\n<td><input type='text' name='".$varname_normal."' value='".set_value($varname_normal,$test_item[$varname_normal])."' size='15' /></td>";
        echo "\n<td><input type='text' name='".$varname_remark."' value='".set_value($varname_remark,$test_item[$varname_remark])."' size='30' /></td>";
        echo "</tr>";
    }//endforeach;
    echo "</table>";
...
?>
    <script  type="text/javascript">
        ...
        function selectLabPackage(){
            $("results_form").status.value="Unfinished";
