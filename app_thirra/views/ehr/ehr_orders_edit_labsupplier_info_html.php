...
echo form_open('ehr_orders/orders_edit_labsupplier_info/'.$form_purpose.'/lab/'.$supplier_id, $attributes);
...
if($form_purpose == "edit_supplier"){
    echo anchor('ehr_orders/orders_edit_lab_package/new_package/'.$supplier_id.'/new_package', '<strong>Add Package</strong>');
}
...
foreach ($packages_list as $packages_item){
    echo "<tr>";
    echo "<td>".anchor('ehr_orders/orders_edit_lab_package/edit_package/'.$supplier_id.'/'.$packages_item['lab_package_id'], $packages_item['package_name'])."</td>";
