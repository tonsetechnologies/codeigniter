...
echo form_open('ehr_individual_refer/send_referral_out2server_done/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$referral_id);
...
echo "\n<tr>";
    echo "\n<td></td>";
    echo "\n<td><br />".anchor('ehr_individual_refer/edit_referral_out/edit_refer/'.$patient_id.'/'.$summary_id.'/'.$referral_id, "<strong>Cancel. Click this to start over</strong>")."</td>";
    echo "\n<td></td>";
echo "\n</tr>";
echo "\n</table>";
