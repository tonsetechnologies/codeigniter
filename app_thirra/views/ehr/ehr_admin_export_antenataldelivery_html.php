...
echo form_open('ehr_admin_edi_export/admin_export_new_antenataldelivery', $attributes);
...
if(isset($unsynched_list)){
    ...
    foreach ($unsynched_list as $unsynched_item){
        ...
        echo "\n<td>";
     	echo anchor('ehr_individual/past_con_details/'.$unsynched_item['patient_id'].'/'.$unsynched_item['antenatal_delivery_id'], $unsynched_item['date_delivery'], 'target="_blank"');
        echo "\n</td>";
