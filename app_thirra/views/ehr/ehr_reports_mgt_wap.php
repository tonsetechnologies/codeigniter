...
echo "\n\n<div id='reports_clinical' class='section'>";
    ...
    echo anchor('ehr_reports/reports_edit_reporthead/new_report/new_report', "<strong>Add New Report</strong>");
    echo "\n<table>";
    echo "\n<tr>";
        echo "\n<th>No.</th>";
        echo "\n<th width='1'></th>";
    ...
    if(isset($clinic_reports_list)){
        ...
        foreach ($clinic_reports_list as $clinrep_item){
            ...
            echo "\n<td>".anchor('ehr_reports/reports_select_report/edit_param/'.$clinrep_item['report_header_id'], 'print', "target='_blank'")." <strong>".$clinrep_item['report_name']."</strong>"."</td>";
            ...
            echo "\n<td>".anchor('ehr_reports/reports_edit_reporthead/edit_report/'.$clinrep_item['report_header_id'], "<strong>Edit</strong>")."</td>";
            echo "\n</tr>";
            $rownum++;
        }//endforeach;
    }
