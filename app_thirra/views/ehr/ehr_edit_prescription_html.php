...
foreach ($prescribe_list as $prescribe_item){
    ...
    echo "<td valign='top'>".anchor('ehr_consult_prescribe/edit_prescription/edit_prescribe/'.$patient_id.'/'.$summary_id.'/'.$prescribe_item['queue_id'], $prescribe_item['generic_name'])."</td>";
    echo "<td valign='top'>".$prescribe_item['dose']."</td>";
    echo "<td valign='top'>".$prescribe_item['dose_form']."</td>";
...
echo form_open('ehr_consult_prescribe/edit_prescription/'.$patient_id, $attributes);
