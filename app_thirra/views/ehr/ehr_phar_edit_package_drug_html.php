...
if(isset($contents_list)){
    ...
    foreach ($contents_list as $content_item){
        ...
        $delete_link    =   base_url()."index.php/ehr_pharmacy/phar_delete_package_drug/".$drug_package_id."/".$content_item['content_id'];
...
echo form_open('ehr_pharmacy/phar_edit_package_drug/'.$form_purpose.'/'.$content_id.'/'.$drug_package_id, $attributes);
...
echo "\n<td>".anchor('ehr_pharmacy/phar_edit_drug_package/edit_package/'.$package_info[0]['drug_package_id'], $package_info[0]['package_name'])."</td></tr>";
