...
echo anchor('ehr_utilities/util_edit_complaint_code/new_code/new_code', "<strong>Add New Complaint Code</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='60'>";
	echo anchor('ehr_utilities/util_list_complaint_codes/commonly_used/0', 'CU');
    echo "</th>";
    echo "\n<th width='40'>";
	echo anchor('ehr_utilities/util_list_complaint_codes/icpc_code/0', 'Code');
    echo "</th>";
    echo "\n<th width='500'>";
	echo anchor('ehr_utilities/util_list_complaint_codes/full_description/0', 'Description');
    echo "</th>";
...
if(isset($complaints_list)){
    ...
    for ($i=0; $i < $per_page; $i++){
        ...
        echo "\n<td>".anchor('ehr_utilities/util_edit_complaint_code/edit_code/'.$complaints_list[$i]['icpc_code'], "<strong>".$complaints_list[$i]['full_description']."</strong>")."</td>";
