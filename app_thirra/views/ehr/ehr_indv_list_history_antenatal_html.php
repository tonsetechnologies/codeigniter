...
echo anchor('ehr_individual_antenatal/edit_history_antenatal/'.$patient_id.'/new_antenatal/new_antenatal', "<strong>Add New Pregnancy</strong>");
echo "\n<br /><br />";
...
if(isset($history_list)){
    ...
    foreach ($history_list as $history_item){
        ...
        if($previous_antenatal_id === $history_item['antenatal_id']){
            ...
            echo "\n<td>".$rownum.".</td>";
            echo "\n<td><strong>".anchor('ehr_individual_antenatal/edit_history_antenatal/'.$patient_id.'/edit_antenatal/'.$history_item['antenatal_id'], $history_item['gravida']);
            echo "</strong></td>";
            echo "\n<td align='center'>".$history_item['para']."</td>";
