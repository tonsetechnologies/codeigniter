...
if($offline_mode == FALSE) {
    echo "\n\n<div id='admin_users' class='section'>";
	    ...
	    echo "\n<p class='section_body'>";
            echo "<p><strong>";
            echo anchor('ehr_admin/edit_staff_category/new_category', 'Add New Category');
            echo "</strong></p>";

            echo "\n<table>";
            echo "\n<tr>";
                echo "\n<th width='250'>";
	            echo anchor('ehr_admin/admin_list_systemusers/username', 'Category');
                echo "</th>";
                echo "\n<th>Description</th>";
            echo "</tr>";
            foreach ($users_list as $user_item){
                echo "<tr>";
                echo "<td>".anchor('ehr_admin/edit_staff_category/edit_category/'.$user_item['category_id'], $user_item['category_name'])."</td>";
