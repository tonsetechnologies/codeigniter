...
echo form_open('ehr_admin_edi_export/admin_export_new_antenatalcheckup', $attributes);
...
if(isset($unsynched_list)){
    ...
    foreach ($unsynched_list as $unsynched_item){
        ...
        echo "\n<td>";
     	echo anchor('ehr_individual/past_con_details/'.$unsynched_item['patient_id'].'/'.$unsynched_item['antenatal_followup_id'], $unsynched_item['date'], 'target="_blank"');
        echo "\n</td>";
