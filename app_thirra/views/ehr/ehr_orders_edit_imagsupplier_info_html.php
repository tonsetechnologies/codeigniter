...
if($form_purpose == "edit_supplier"){
    echo anchor('ehr_orders/orders_edit_imag_product/new_product/imag/'.$supplier_id.'/new_product', '<strong>Add Package</strong>');
}
...
foreach ($packages_list as $packages_item){
    echo "<tr>";
    echo "<td>".anchor('ehr_orders/orders_edit_imag_product/edit_product/imag/'.$supplier_id.'/'.$packages_item['product_id'], $packages_item['product_code'])."</td>";
