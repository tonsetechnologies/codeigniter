...
echo anchor('ehr_pharmacy_supplier/phar_edit_drugsupplier_info/new_supplier/drug/new_supplier', "<strong>Add New Supplier</strong>");
echo "\n<br /><br />";
...
if(isset($supplier_list)){
    ...
    foreach ($supplier_list as $supplier_item){
        ...
        echo "\n<td>".anchor('ehr_pharmacy_supplier/phar_edit_drugsupplier_info/edit_supplier/drug/'.$supplier_item['supplier_id'], "<strong>".$supplier_item['supplier_name']."</strong>")."</td>";
        echo "\n<td>".$supplier_item['contact_person']."</td>";
        echo "\n<td>".$supplier_item['tel_no']."</td>";
        echo "\n<td>".anchor('ehr_pharmacy_supplier/phar_list_drug_supplierinvoices/'.$supplier_item['supplier_id'], "Invoices")."</td>";
        echo "\n</tr>";
        $rownum++;
    }//endforeach;
}
