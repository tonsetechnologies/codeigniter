...
foreach ($imaging_list as $imaging_item){
    echo "<tr>";
    echo "<td>".anchor('ehr_consult_orders/edit_imaging/edit_imaging/'.$patient_id.'/'.$summary_id.'/'.$imaging_item['order_id'], $imaging_item['product_code'])."</td>";
...
echo form_open('ehr_consult_orders/edit_imaging/'.$patient_id, $attributes);
