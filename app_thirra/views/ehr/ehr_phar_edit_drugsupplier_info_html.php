...
echo form_open('ehr_pharmacy_supplier/phar_edit_drugsupplier_info/'.$form_purpose.'/drug/'.$supplier_id, $attributes);
...
if($form_purpose == "edit_supplier"){
    echo anchor('ehr_pharmacy_supplier/phar_edit_drug_product/new_product/drug/'.$supplier_id.'/new_product', '<strong>Add Drug Product</strong>');
}
echo "\n<br /><br /><table class='tablebg_blue'>";
echo "\n<tr>";
    echo "\n<th width='80'>Commonly Used</th>";
    echo "\n<th width='80'>Code</th>";
    echo "\n<th width='350'>Trade name</th>";
    echo "\n<th>Generic name</th>";
    echo "\n<th>System</th>";
...
foreach ($packages_list as $packages_item){
    ...
    echo "<td valign='top'>".anchor('ehr_pharmacy_supplier/phar_edit_drug_product/edit_product/drug/'.$supplier_id.'/'.$packages_item['product_id'], $packages_item['trade_name'])."</td>";
    //echo "<td><strong>".$packages_item['trade_name']."</strong></td>";
    echo "<td valign='top'>".$packages_item['generic_name']."</td>";
