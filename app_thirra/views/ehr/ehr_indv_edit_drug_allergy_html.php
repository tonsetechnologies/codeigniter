...
if(!empty($allergies_list)){
    foreach ($allergies_list as $allergies_item){
        echo "\n<tr>";
        echo "<td>".anchor('ehr_individual/edit_drug_allergy/edit_allergy/'.$patient_id.'/'.$allergies_item['patient_drug_allergy_id'], $allergies_item['generic_name'])."</td>";
...
echo "\n\n<div id='patients_new_prescribe' class='section'>\n";
    ...
    echo form_open('ehr_individual/edit_drug_allergy/'.$patient_id, $attributes);
