...
echo "\n<tr>";
    ...
    echo "\n<td>  </td>";
    echo "<td>";
    echo anchor('ehr_utilities/util_edit_diagnosis_info/edit_code/'.$diagnosis_top[0]['dcode1_id'], "<strong>[Edit]</strong>");
    echo "</td>";
echo "</tr>";
echo "\n<tr>";
    echo "\n<td>Chapter</td>";
...
echo anchor('ehr_utilities/util_edit_diagnosisext_info/new_code/'.$dcode1_id.'/new_code', "<strong>Add New Diagnosis Code</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='160'>";
	echo anchor('ehr_utilities/util_list_diagnosiscodes/commonly_used/0', 'Commonly Used');
    echo "</th>";
    echo "\n<th width='60'>";
	echo anchor('ehr_utilities/util_list_diagnosiscodes/dcode1_code/0', 'Code');
    echo "</th>";
    echo "\n<th width='500'>";
	echo anchor('ehr_utilities/util_list_diagnosiscodes/full_title/0', 'Diagnosis');
    echo "</th>";
...
if(isset($diagnosis_list)){
    ...
    for ($i=0; $i < count($diagnosis_list); $i++){
        ...
        echo "\n<td valign='top'>".anchor('ehr_utilities/util_edit_diagnosisext_info/edit_code/'.$diagnosis_list[$i]['dcode1_id'].'/'.$diagnosis_list[$i]['dcode1ext_id'], $diagnosis_list[$i]['dcode1ext_longname'])."</td>";
