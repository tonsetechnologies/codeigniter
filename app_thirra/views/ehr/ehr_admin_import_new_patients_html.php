...
echo form_open('ehr_admin_edi_import/admin_import_new_patientsdone/'.$filename, $attributes);
...
if(isset($unsynched_list)){
    foreach ($unsynched_list as $unsynched_item){
        ...
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr_individual/individual_overview/'.$unsynched_item['patient_id'], "<strong>".$unsynched_item['patient_name']."</strong>, ".$unsynched_item['name_first'], 'target="_blank"')."</td>";
