...
echo "\n\n<div id='orders_closed' class='section'>";
	echo "\n<p class='section_title'>";
	echo "<h2>Closed Orders</h2></p>";
	echo "\n<p class='section_body'>";
    echo "\n<br />".anchor('ehr_orders/ehr_orders_list_labsuppliers/lab', 'Laboratory Orders');
    echo "\n<br />".anchor('ehr_orders/ehr_orders_list_imagsuppliers/imaging', 'Imaging Orders');
    echo "\n<br />".anchor('ehr_orders/ehr_orders_list_procsuppliers/procedure', 'Procedures Orders');
	echo "<br />";
	echo "</p>";
echo "</div>";
