...
echo anchor('bio_utilities/util_edit_village_info/new_village/new_village', "<strong>Add New Village</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='110'>";
	echo anchor('bio_utilities/util_list_addrvillages/addr_village_code', 'Code');
    echo "</th>";
    echo "\n<th width='300'>";
	echo anchor('bio_utilities/util_list_addrvillages/addr_village_name', 'Village Name');
    echo "</th>";
    echo "\n<th width='250'>";
	echo anchor('bio_utilities/util_list_addrvillages/addr_town_name', 'Town');
    echo "</th>";
    echo "\n<th width='250'>";
	echo anchor('bio_utilities/util_list_addrvillages/addr_area_name', 'Area');
    echo "</th>";
    echo "\n<th width='200'>";
	echo anchor('bio_utilities/util_list_addrvillages/addr_district_name', 'District');
    echo "</th>";
    echo "\n<th width='50'>Sort</th>";
...
if(isset($village_list)){
    ...
    foreach ($village_list as $village_item){
        ...
        echo "\n<td>".anchor('bio_utilities/util_edit_village_info/edit_village/'.$village_item['addr_village_id'], "<strong>".$village_item['addr_village_name']."</strong>")."</td>";
