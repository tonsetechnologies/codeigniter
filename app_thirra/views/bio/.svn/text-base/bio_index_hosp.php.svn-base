...
echo "\n<div align='center'><h1>THIRRA - Hospital Biosurveillance</h1></div>";

echo "<p>";
echo "The duty of the hospital based Public Health Inspector is to record Communicable Disease Notifications.";
echo "</p>";
...
foreach ($fresh_list as $case){
    ...
    echo "\n<tr>";
        echo "<td>$rowcount.</td>";
        echo "<td>". anchor('bio_hospital/edit_notify544/edit_notify/'.$case['patient_id'].'/'.$case['notification_id'], 'Edit') ."</td>";
        ...
        echo "<td>".$case['short_title']."</td>";
        echo "<td>".$case['patient_town']."</td>";
        echo "<td>";
	    echo anchor('bio_hospital/print_form544/html/'.$case['patient_id'].'/'.$case['summary_id'], 'html', 'target="_blank"');
        echo " ";
	    echo anchor('bio_hospital/print_form544/pdf/'.$case['patient_id'].'/'.$case['summary_id'], 'pdf', 'target="_blank"');
        echo "</td>";
    echo "</tr>";
    $rowcount++;
}//endforeach;
echo "</table>";
echo anchor('bio_hospital/cases_fresh', 'More fresh cases');
...
echo "</table>";
echo anchor('bio_hospital/cases_open', 'More open cases');
...
echo "</table>";
echo anchor('bio_hospital/cases_closed', 'More closed cases');
