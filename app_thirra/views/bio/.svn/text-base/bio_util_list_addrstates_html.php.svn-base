...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='110'>";
	echo anchor('bio_utilities/util_list_addrstates/addr_state_code', 'Code');
    echo "</th>";
    echo "\n<th width='300'>";
	echo anchor('bio_utilities/util_list_addrstates/addr_state_name', 'State Name');
    echo "</th>";
    echo "\n<th width='200'>";
	echo anchor('bio_utilities/util_list_addrstates/addr_state_country', 'Country');
    echo "</th>";
    echo "\n<th width='50'>Sort</th>";
...
if(isset($state_list)){
    ...
    foreach ($state_list as $state_item){
        ...
        echo "\n<td>".anchor('bio_utilities/util_edit_state_info/edit_state/'.$state_item['addr_state_id'], "<strong>".$state_item['addr_state_name']."</strong>")."</td>";
