...
echo anchor('bio_utilities/util_edit_area_info/new_area/new_area', "<strong>Add New Area</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='110'>";
	echo anchor('bio_utilities/util_list_addrareas/addr_area_code', 'Code');
    echo "</th>";
    echo "\n<th width='300'>";
	echo anchor('bio_utilities/util_list_addrareas/addr_area_name', 'Area Name');
    echo "</th>";
    echo "\n<th width='200'>";
	echo anchor('bio_utilities/util_list_addrareas/addr_district_name', 'District');
    echo "</th>";
    echo "\n<th width='50'>Sort</th>";
...
if(isset($area_list)){
    ...
    foreach ($area_list as $area_item){
        ...
        echo "\n<td>".anchor('bio_utilities/util_edit_area_info/edit_area/'.$area_item['addr_area_id'], "<strong>".$area_item['addr_area_name']."</strong>")."</td>";
