...
foreach($acl_menu as $acl_item){
    echo "\n<td width='200' class='banner_button_enabled'>";
    if($acl_item['rights_single'] > 0){
        echo "<a href='".site_url().$acl_item['syssection_link_url']."'>";
...
// No longer showing as breadcrumbs are retrieved from module and not mail. Retrieval is done later.
...
$siteurl_home       =   site_url()."/ehr/ehr/index/ehr_dashboard/ehr_dashboard/index";
$siteurl_patients   =   site_url()."/ehr/ehr/index/ehr_patients/ehr_patient/patients_mgt";
$siteurl_pharmacy   =   site_url()."/ehr/ehr/index/ehr_pharmacy/ehr_pharmacy/pharmacy_mgt";
$siteurl_orders     =   site_url()."/ehr/ehr/index/ehr_orders/ehr_orders/orders_mgt";
$siteurl_queue      =   site_url()."/ehr/ehr/index/ehr_queue/ehr_queue/queue_mgt";
$siteurl_reports    =   site_url()."/ehr/ehr/index/ehr_reports/ehr_reports/reports_mgt";
$siteurl_utilities  =   site_url()."/ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt";
$siteurl_admin      =   site_url()."/ehr/ehr/index/ehr_admin/ehr_admin/admin_mgt";
