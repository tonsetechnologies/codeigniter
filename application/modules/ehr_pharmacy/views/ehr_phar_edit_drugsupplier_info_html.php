...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('phar_edit_drugsupplier_info_html_title')."</h1></div>";

echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";


$attributes =   array('class' => 'select_form', 'id' => 'consultation_form');
echo form_open('ehr/ehr/index/ehr_pharmacy/ehr_pharmacy_supplier/phar_edit_drugsupplier_info/'.$form_purpose.'/drug/'.$supplier_id, $attributes);
...
if($form_purpose == "edit_supplier"){
    echo anchor('ehr/ehr/index/ehr_pharmacy/ehr_pharmacy_supplier/phar_edit_drug_product/new_product/drug/'.$supplier_id.'/new_product', '<strong>Add Drug Product</strong>');
}
echo "\n<br /><br /><table class='tablebg_blue'>";
echo "\n<tr>";
    echo "\n<th width='80'>Commonly Used</th>";
    echo "\n<th width='80'>Code</th>";
    echo "\n<th width='400'>Trade name</th>";
    echo "\n<th>Generic name</th>";
    //echo "\n<th>System</th>";
    echo "\n<th>Cost (".$app_currency.")</th>";
    echo "\n<th>Retail <br />Price 1</th>";
echo "</tr>";
foreach ($products_list as $packages_item){
    echo "<tr>";
    echo "<td align='center' valign='top'>".$packages_item['commonly_used']."</td>";
    echo "<td valign='top'>".$packages_item['seller_code']."</td>";
    echo "<td valign='top'>".anchor('ehr/ehr/index/ehr_pharmacy/ehr_pharmacy_supplier/phar_edit_drug_product/edit_product/drug/'.$supplier_id.'/'.$packages_item['product_id'], $packages_item['product_name']."<br />(".$packages_item['trade_name'].")")."</td>";
    //echo "<td><strong>".$packages_item['trade_name']."</strong></td>";
    echo "<td valign='top'>".$packages_item['generic_name']."<br />(".$packages_item['drug_system'].")</td>";
    //echo "<td valign='top'>".$packages_item['drug_system']."</td>";
    echo "<td align='right' valign='top'>".$packages_item['ucost_std']."</td>";
    echo "<td align='right' valign='top'>".$packages_item['retail_price']."</td>";
    echo "</tr>";
}//endforeach;
echo "</table>";
echo "\n</fieldset>";
