...
echo "\n<fieldset>";
echo "<legend>ARCHIVED PRESCRIPTIONS LIST</legend>";
        echo "\n<table>";
            echo "\n<tr>";
                echo "\n<th>print</th>";
        ...
        foreach ($prescription_info as $prescription_item){
            echo "\n<tr>";
            echo "<td>";
            echo anchor('ehr/ehr/index/ehr_pharmacy/ehr_pharmacy/print_prescription/'.$prescription_item['patient_id'].'/'.$prescription_item['session_id'], 'html', "target='_blank'");
            echo " ";
            echo anchor('ehr/ehr/index/ehr_pharmacy/ehr_pharmacy/print_prescription/'.$prescription_item['patient_id'].'/'.$prescription_item['session_id'], 'pdf', "target='_blank'");
            echo "</td>";
