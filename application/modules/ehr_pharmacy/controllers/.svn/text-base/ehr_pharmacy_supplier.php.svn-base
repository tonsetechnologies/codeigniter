 ...
 */
class Ehr_pharmacy_supplier extends MX_Controller 
{
    ...
    // === PHARMACY MANAGEMENT
    // ------------------------------------------------------------------------
    function phar_list_drug_suppliers($seg3)  // List suppliers for drugs
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_phar_list_drugsuppliers_html";
    ...
    // ------------------------------------------------------------------------
    function phar_edit_drugsupplier_info($seg3,$seg4,$seg5)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['products_list']= $this->mpharma_rdb->get_drug_product_bysupplier($data['supplier_id'],$data['init_location_id']);
		...
		if ($this->form_validation->run('edit_drug_supplier') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_phar_edit_drugsupplier_info_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_pharmacy/ehr_pharmacy_supplier/phar_list_drug_suppliers/".$data['supplier_type'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function phar_edit_drug_product($seg3,$seg4,$seg5,$seg6)
    {
        ...
        if(count($_POST)) {
            ...
            if ($data['form_purpose'] == "new_product") {
                ...
                $data['product_info'] = $this->mpharma_rdb->get_drug_product_bysupplier($data['supplier_id'],NULL,$data['product_id']);
		...
		if ($this->form_validation->run('edit_drug_product') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_phar_edit_drug_product_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_product") {
                ...
                $upd_drug_array['edit_staff']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_pharmacy/ehr_pharmacy_supplier/phar_edit_drugsupplier_info/edit_supplier/drug/".$data['init_supplier_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function phar_list_drug_supplierinvoices($seg3)  // List suppliers for imaging
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_pharmacy_wap";
            //$new_body   =   "ehr/ehr_orders_list_imagsuppliers_wap";
            $new_body   =   "ehr_phar_list_drugsupplier_invoices_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function phar_edit_drug_supplierinvoice($id=NULL) 
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_reports/ehr_reports/reports_edit_reporthead/edit_report/".$data['report_header_id'];
            header("Status: 200");
            header("Location: ".$new_page);
