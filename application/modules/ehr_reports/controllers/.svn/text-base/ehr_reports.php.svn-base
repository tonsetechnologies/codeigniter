 ...
 */
class Ehr_reports extends MX_Controller 
{
    ...
    // ------------------------------------------------------------------------
    function reports_edit_reporthead($seg3,$seg4) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        $data['report_header_id']   =   $seg4; //$this->uri->segment(4);
		...
		if ($this->form_validation->run('edit_report_header') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_reports_edit_reporthead_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_reports/ehr_reports/reports_mgt";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function reports_edit_reportbody($seg3,$seg4,$seg5) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['report_header_id']   =   $seg4; //$this->uri->segment(4);
        $data['report_body_id']     =   $seg5; //$this->uri->segment(5);
		...
		if ($this->form_validation->run('edit_report_body') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_reports_edit_reportbody_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function reports_delete_reportbody($seg3,$seg4) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['report_header_id']   =   $seg3; //$this->uri->segment(3);
        $data['report_body_id']     =   $seg4; //$this->uri->segment(4);
    ...
    // ------------------------------------------------------------------------
    function reports_select_report($seg3,$seg4) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		if ($this->form_validation->run('edit_report_param') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_reports_select_report_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function print_report($seg3,$seg4,$seg5,$seg6,$seg7,$seg8)  // Print lab result to HTML or PDF
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        $data['form_purpose']   =   $seg3; //$this->uri->segment(3);
        $data['report_header_id'] =   $seg4; //$this->uri->segment(4);
        $data['period_from']    =   $seg5; //$this->uri->segment(5);
        $data['period_to']      =   $seg6; //$this->uri->segment(6);
        $data['clinic_info_id'] =   $seg7; //$this->uri->segment(7);
        $data['patient_id']     =   $seg8; //$this->uri->segment(8);
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_wap";
            $new_sidebar=   "ehr/sidebar_ehr_reports_wap";
            $new_body   =   "ehr_print_report_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
