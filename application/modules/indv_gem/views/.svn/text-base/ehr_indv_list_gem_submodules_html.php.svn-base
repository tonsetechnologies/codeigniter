...
if(isset($submodules_list)){
    ...
    foreach ($submodules_list as $submodule_item){
        ...
        echo "\n<td valign='top'>";
        echo anchor('indv/indv/index/indv_gem/ehr_individual_gem/list_history_gemsubmodule/list_modules/'.$patient_id.'/'.$module_info[0]['gem_module_id'].'/'.$submodule_item['gem_submod_id'], $submodule_item['gem_submod_name']);
        echo "</td>";
