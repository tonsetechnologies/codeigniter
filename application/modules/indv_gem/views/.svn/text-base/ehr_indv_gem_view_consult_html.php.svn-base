...
echo "\n<tr>";
    ...
    echo anchor('indv/indv/index/indv_gem/ehr_individual_gem/list_gem_submodules/list_submodules/'.$patient_id.'/'.$submodule_info[0]['gem_module_id'], $submodule_info[0]['gem_module_name']);
    echo "</strong></td>";
