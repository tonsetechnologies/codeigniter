...
echo "\n<tr>";
    ...
    echo anchor('cons/cons/index/cons_gem/ehr_consult_gem/list_gem_submodules/list_submodule/'.$patient_id.'/'.$summary_id.'/'.$submodule_info[0]['gem_module_id'], $submodule_info[0]['gem_module_name']);
    echo "</strong></td>";
...
echo form_open('cons/cons/index/cons_gem/ehr_consult_gem/gem_edit_consult/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$gem_submod_id.'/'.$gem_agegroup_id, $attributes);
