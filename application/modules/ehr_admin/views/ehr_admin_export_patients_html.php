...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('admin_export_patients_html_title')."</h1></div>";


echo "\n<fieldset>";
echo "<legend>UNSYNCHED PATIENTS</legend>";
$attributes =   array('class' => 'select_form', 'id' => 'export_form');
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin_edi_export/admin_export_new_patients', $attributes);
...
if(isset($unsynched_list)){
    ...
    foreach ($unsynched_list as $unsynched_item){
        echo "\n<tr>";
        echo "\n<td><input type='checkbox' name='s$rownum' value='".$unsynched_item['patient_id']."-.-".$unsynched_item['name']."-.-".$unsynched_item['name_first']."-.-".$unsynched_item['birth_date']."-.-".$unsynched_item['gender']."-.-".$unsynched_item['synch_out']."' checked='checked' /></td>";
        echo "\n<td>".$rownum.".</td>";
...
echo "\n<fieldset>";
echo "<legend>EXPORTED PATIENTS</legend>";
