...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('admin_export_new_patients_html_title')."</h1></div>";


echo "\n<fieldset>";
echo "<legend>EXPORT PATIENTS</legend>\n";
$attributes =   array('class' => 'select_form', 'id' => 'export_form');
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin_edi_export/admin_export_new_patientsdone', $attributes);
