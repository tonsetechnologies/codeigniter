...
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_centre/'.$form_purpose.'/'.$referral_center_id, $attributes);
...
echo "<input type='text' name='pcdom_ref' value='".set_value('pcdom_ref',$init_pcdom_ref)."' size='20' /></td></tr>";

echo "\n<tr><td>DMZ URL</td><td>";
echo form_error('thirra_url');
echo "<input type='text' name='thirra_url' value='".set_value('thirra_url',$init_thirra_url)."' size='50' /></td></tr>";
...
echo "\n<br />";
echo "\n<center>";
    echo "\n<input class='button' type='submit' name='submit' value='Add/Edit Centre' />";
echo "\n</center>";
...
echo "<strong>";
if("new_centre" <> $referral_center_id){
    echo anchor('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_person/new_person/'.$referral_center_id.'/new_person/'.$partner_clinic_id, 'Add Person');
} else {
    echo "Add Person";
}
echo "\n</strong><br /><br />";
if(!empty($persons_list)){
    ...
    foreach ($persons_list as $person_item){
        echo "<tr>";
        echo "<td>".anchor('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_person/edit_person/'.$referral_center_id.'/'.$person_item['referral_doctor_id'].'/'.$partner_clinic_id, $person_item['doctor_name'])."</td>";
    ...
    echo "\n<font color='red'>PLEASE ADD A REFERRAL PERSON!</font>";
}
echo "\n</fieldset>";
