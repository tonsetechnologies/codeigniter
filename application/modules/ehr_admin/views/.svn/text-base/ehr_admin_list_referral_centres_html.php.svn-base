...
echo "<p><strong>";
echo anchor('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_centre/new_centre', 'Add New Centre');
echo "</strong></p>";
echo "\n<br />";
...
foreach ($centres_list as $centre_item){
    echo "<tr>";
    echo "<td>".anchor('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_centre/edit_centre/'.$centre_item['referral_center_id'], $centre_item['name'])."</td>";
