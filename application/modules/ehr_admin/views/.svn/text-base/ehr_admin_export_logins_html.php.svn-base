...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('admin_export_logins_html_title')."</h1></div>";


echo "\n<fieldset>";
echo "<legend>UNSYNCHED LOGINS</legend>";
$attributes =   array('class' => 'select_form', 'id' => 'export_form');
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin_edi_export/admin_export_new_logins_done', $attributes);
...
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin_edi/admin_export_new_patients', $attributes);
...
if(isset($synched_list)){
    ...
    foreach ($synched_list as $synched_item){
        ...
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr/ehr/index/ehr_admin/ehr_admin/individual_overview/'.$synched_item['patient_id'], "<strong>".$synched_item['name']."</strong>, ".$synched_item['name_first'], 'target="_blank"')."</td>";
