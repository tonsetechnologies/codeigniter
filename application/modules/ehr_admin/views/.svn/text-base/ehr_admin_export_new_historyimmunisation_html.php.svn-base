...
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin_edi_export/admin_export_new_historyimmunisation_done', $attributes);
...
if(isset($unsynched_list)){
    ...
    foreach ($unsynched_list as $unsynched_item){
        ...
        echo "\n<td>";
     	echo anchor('indv/indv/index/indv_overview/ehr_individual/past_con_details/print_hardcopy/'.$unsynched_item['patient_id'].'/'.$unsynched_item['patient_immunisation_id'], $unsynched_item['immunisation_date'], 'target="_blank"');
        echo "\n</td>";
