...
echo form_open('ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_person/'.$referral_doctor_id, $attributes);
...
echo "\n<tr>";
    ...
    echo "\n<td>";
    echo "\n<textarea class='normal' name='remarks'  rows='4' cols='50'>".set_value('remarks',$init_remarks)."</textarea>";
    echo "\n</td>";
echo "\n</tr>";
...
echo "\n<br />";
echo "\n<center>";
    echo "\n<input class='button' type='submit' name='submit' value='Add/Edit Person' />";
echo "\n</center>";
