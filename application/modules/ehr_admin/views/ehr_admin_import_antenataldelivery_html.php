...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('admin_import_antenataldelivery_html_title')."</h1></div>";
...
if(isset($fileList)){
    ...
    foreach ($fileList as $unsynched_item){
	    if (is_file("$directory/$unsynched_item") && $unsynched_item != '.' && $unsynched_item != '..' && (substr($unsynched_item,0,25)=="patient_antenataldelivery")) {
		    echo "\n<tr>";
            echo "\n<td>".$rownum.".</td>";
            ...
            echo "\n<td> &nbsp; ".anchor('ehr/ehr/index/ehr_admin/ehr_admin_edi_import/admin_import_new_antenataldelivery/import_delivery/'.$unsynched_item, 'Import')."</td>";
            echo "\n</tr>";
            $rownum++;
	    }
    }//endforeach;
