 ...
 */
class Ehr_admin extends MX_Controller 
{
    ...
    // ------------------------------------------------------------------------
    function admin_list_systemusers($seg3)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_admin_list_systemusers_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function edit_systemuser($seg3,$seg4) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		$data['user_id'] 			= $seg4; //$this->uri->segment(4);
		...
		$data['user_clinics'] = $this->madmin_rdb->get_user_clinics($data['username']);
		...
		if ($this->form_validation->run('edit_systemuser') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_admin_edit_systemuser_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_systemuser") {
                ...
                $ins_user_array['clerk_id']         = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_list_systemusers";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function admin_list_staffcategories($seg3)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['app_country']		=	$this->config->item('app_country');
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_admin_wap";
            //$new_body   =   "ehr/ehr_admin_list_systemusers_wap";
            $new_body   =   "ehr_admin_list_staffcategories_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function edit_staff_category($seg3,$seg4) 
    {
		...
		$data['form_purpose'] 		= $seg3; //$this->uri->segment(3);
		$data['category_id'] 			= $seg4; //$this->uri->segment(4);
        ...
        if(count($_POST)) {
            ...
            $data['can_consult']            =   $this->input->post('can_consult');
            ...
            $data['acl_single']           = $this->madmin_rdb->get_systemsection_acl($data['category_id']);
            //$data['acl_single']             =   $this->madmin_rdb->get_system_sections();
            $rownum     =   0;
            foreach($data['acl_single'] as $single_item){
                $syssection_id              =   $single_item['syssection_id'];
                $single_acl_id              =   $single_item['acl_id'];
                $data['acl_single'][$rownum]['single_'.$syssection_id]  = $_POST['single_'.$syssection_id];
                $data['acl_single'][$rownum]['multi_'.$syssection_id]   = $_POST['multi_'.$syssection_id];
                $rownum++;
            }
            /*
            echo "<pre>";
            ...
            */
            ...
            if ($data['form_purpose'] == "new_category") {
                ...
                $data['can_consult']    =   $data['category_info']['can_consult'];
		...
		if ($this->form_validation->run('edit_staff_category') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_sidebar=   "ehr/sidebar_ehr_admin_wap";
                //$new_body   =   "ehr/emr_edit_systemuser_wap";
                $new_body   =   "ehr_admin_edit_staff_category_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            */
            ...
            if($data['form_purpose'] == "new_category") {
                ...
                $ins_cate_array['can_consult']      = $data['can_consult'];
                $ins_cate_array['permission']       = $data['rights_decimal'];
                $ins_cate_array['acl_single']       = $data['acl_single'];
                $ins_cate_array['added_staff']      = $this->session->userdata('staff_id');
                ...
                $upd_cate_array['can_consult']      = $data['can_consult'];
                $upd_cate_array['permission']       = $data['rights_decimal'];
                $upd_cate_array['acl_single']       = $data['acl_single'];
                $upd_cate_array['acl_remarks']      = "";//$data['acl_remarks'];
                $upd_cate_array['edit_remarks']     = "";//$data['edit_remarks'];
                //echo "data['rights_decimal']".$data['rights_decimal'];
                $upd_cate_array['edit_staff']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_list_staffcategories";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function admin_list_clinics($seg3)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_admin_list_clinics_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function admin_edit_clinic_info($seg3,$seg4)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['app_country']		=	$this->config->item('app_country');
        ...
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['clinic_info_id']         =   $seg4; //$this->uri->segment(4);
		$data['staff_list'] = $this->madmin_rdb->get_staff_per_clinic($data['clinic_info_id']);
		$data['healthdept_list'] = $this->madmin_rdb->get_healthdept_list();
		...
		if ($this->form_validation->run('edit_clinic_info') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_admin_edit_clinic_info_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_clinic") {
                ...
                $ins_clinic_array['staff_id']       = $this->session->userdata('staff_id');
                ...
                $upd_clinic_array['staff_id']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_list_clinics/sort_clinic";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function admin_list_depts($seg3)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['country']		    =	$this->config->item('app_country');
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_admin_wap";
            //$new_body   =   "ehr/ehr_admin_list_clinics_wap";
            $new_body   =   "ehr_admin_list_depts_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_edit_clinic_dept($seg3,$seg4)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['clinic_dept_id']     =   $seg4; //$this->uri->segment(4);
        $data['location_id']        =   $this->session->userdata('location_id');
		...
		if ($this->form_validation->run('edit_clinic_dept') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_wap";
                $new_sidebar=   "ehr/sidebar_ehr_admin_wap";
                $new_body   =   "ehr_admin_edit_clinic_dept_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_dept") {
                ...
                $ins_dept_array['staff_id']       = $this->session->userdata('staff_id');
                ...
                $upd_dept_array['staff_id']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_list_depts/dept_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function admin_list_referral_centres($id=NULL)
    {
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_admin_list_referral_centres_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_edit_referral_centre($seg3,$seg4)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr_admin/admin_mgt','Admin','ehr_admin/admin_list_referral_centres','List Referral Centres');    
	  	$this->load->model('mthirra');
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['referral_center_id'] =   $seg4; //$this->uri->segment(4);
		...
		if ($this->form_validation->run('edit_referral_centre') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_admin_edit_referral_centre_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_centre") {
                ...
                $ins_centre_array['staff_id']       = $this->session->userdata('staff_id');
                ...
                $upd_centre_array['staff_id']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_list_referral_centres";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function admin_edit_referral_person($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if(count($_POST)) {
            ...
            $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
            $data['referral_center_id'] =   $seg4; //$this->uri->segment(4);
            $data['referral_doctor_id'] =   $seg5; //$this->uri->segment(5);
            $data['partner_clinic_id']  =   $seg6; //$this->uri->segment(6);
        ...
        if(isset($data['partner_clinic_id'])){
            ...
            $data['staff_list'] = $this->madmin_rdb->get_staff_per_clinic($data['partner_clinic_id']);
        } else {
            $data['partner_info'] = array();
        }
		...
		if ($this->form_validation->run('edit_referral_person') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_admin_edit_referral_person_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_admin/ehr_admin/admin_edit_referral_centre/edit_centre/".$data['referral_center_id'];
            header("Status: 200");
            header("Location: ".$new_page);
