 ...
 */
class Ehr_admin_edi_export extends MX_Controller 
{
    ...
    function admin_export_logins($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_admin_export_logins_html";
    ...
    function admin_export_new_logins_done($id=NULL)  // template for new classes
    {
        ...
        $data['export_clinic']    =   $this->mthirra->get_clinic_info($this->session->userdata('location_id'));
        ...
        $version_file_path          = $data['app_path']."/application/version.txt";
        ...
        if(count($_POST)) {
			...
			$selected		=	1;
					...
					//$data['unsynched_list'][$selected]['immunisation_info'] = $this->mprescribe_rdb->get_vaccines_list($patient_id,$immunisation_id);
            $data['unsynched_list'] = $this->madmin_rdb->get_unsynched_logins('ALL');
                if($data['debug_mode']){
                    echo "<pre>";
        ...
        $ins_log_array['export_by']         = $this->session->userdata('staff_id');
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_new_logins_done_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_patients($id=NULL)  // template for new classes
    {
        ...
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['home_clinic']        =   $this->session->userdata('location_id');
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_patients_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_new_patients($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_new_patients_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_new_patientsdone($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_new_patientsdone_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_antenatal_info($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_antenatalinfo_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenatalinfo($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        if(count($_POST)) {
            // User has posted the form
            $data['form_purpose']   = $seg3; //$_POST['form_purpose'];
            $data['num_rows']       = $_POST['num_rows'];
			$selected_count		=	1;
			for($i=1; $i<=$data['num_rows']; $i++){
				if(isset($_POST['s'.$i])){
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenatalinfo_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenatalinfo_done($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenatalinfo_done_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_export_antenatal_checkup($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_antenatalcheckup_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenatalcheckup($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenatalcheckup_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenatalcheckup_done($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenatalcheckup_done_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_export_antenatal_delivery($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_antenataldelivery_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenataldelivery($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenataldelivery_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_antenataldelivery_done($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_antenataldelivery_done_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_export_episodes($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_episodes_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_new_episodes($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_new_episodes_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_export_new_episodesdone($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_new_episodesdone_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    function admin_list_open_episodes($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_list_open_episodes_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_export_history_immunisation($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_admin_export_historyimmunisation_html";
            $new_footer =   "ehr/footer_emr_html";
		}
        if($data['user_rights']['section_admin'] < 100){
            $new_body   =   "ehr/ehr_access_denied_html";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_historyimmunisation($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
			...
			for($i=1; $i<=$data['num_rows']; $i++){
				...
				// Only retrieve if selected by user
					...
					list(
						...
						$data['unsynched_list'][$selected_count]["birth_date"],
						$data['unsynched_list'][$selected_count]["gender"],
						$data['unsynched_list'][$selected_count]["immunisation_date"],
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_historyimmunisation_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function admin_export_new_historyimmunisation_done($seg3)  // template for new classes
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        if(count($_POST)) {
			...
			for($i=1; $i<=$data['num_rows']; $i++){
				...
				if(isset($_POST['s'.$i])){
					...
					$data['unsynched_list'][$selected]['value']	= $_POST['s'.$i];
					list($patient_immunisation_id, $immunisation_id, $patient_id) = explode("-.-", $data['unsynched_list'][$selected]['value']);					$data['unsynched_list'][$selected]['patient_info']   = $this->memr_rdb->get_patient_demo($patient_id);
					$data['unsynched_list'][$selected]['immunisation_info'] = $this->mprescribe_rdb->get_vaccines_list($patient_id,999, 0, $immunisation_id);
					//$data['unsynched_list'][$selected]['checkup_info'] = $this->memr_rdb->get_antenatal_followup('one',$patient_id, $antenatal_id, $antenatal_followup_id);
					if($data['debug_mode']){
						echo "<pre>";
						echo "\n<br />print_r(patient_info)=<br />";
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_emr_wap";
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_admin_export_new_historyimmunisation_done_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
