...
echo anchor('indv/indv/index/indv_overview/ehr_individual/edit_history_social/'.$patient_id.'/new_history/new_history', "<strong>Add New Relationship</strong>");
echo "\n<br /><br />";
...
if(isset($family_above)){
    ...
    foreach ($family_above as $above_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('indv/indv/index/indv_overview/ehr_individual/individual_overview/overview/'.$above_item['patient_id'], "<strong>".$above_item['name']."</strong>", 'target="_blank"')."</td>";
...
if(isset($family_below)){
    ...
    foreach ($family_below as $below_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('indv/indv/index/indv_overview/ehr_individual/individual_overview/overview/'.$below_item['patient_id'], "<strong>".$below_item['name']."</strong>, ".$below_item['name_first'], 'target="_blank"')."</td>";
