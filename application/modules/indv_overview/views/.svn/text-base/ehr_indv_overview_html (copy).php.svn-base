...
if($patcon_info['summary_id'] == "new_summary"){
    echo anchor('cons/cons/index/cons_progress/ehr_consult/consult_new/new_episode/'.trim($patient_info['patient_id']).'/'.$patcon_info['summary_id'], 'Start New Consultation', 'target="_blank"');
} else {
    echo anchor('cons/cons/index/cons_progress/ehr_consult/consult_episode/edit_episode/'.trim($patient_info['patient_id']).'/'.$patcon_info['summary_id'], 'Continue Consultation started on '.$patcon_info['date_started'], 'target="_blank"');
