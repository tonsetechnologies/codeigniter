...
if($user_rights['can_consult'] > 0){
    echo "\n<p /><span class='simple_button_yellow' >";
    if($patcon_info['summary_id'] == "new_summary"){
        echo anchor('cons/cons/index/cons_progress/ehr_consult/consult_new/new_episode/'.trim($patient_info['patient_id']).'/'.$now_id.'/'.$patcon_info['summary_id'], 'Start New Consultation', 'target="_blank"');
    } else {
        echo anchor('cons/cons/index/cons_progress/ehr_consult/consult_episode/edit_episode/'.trim($patient_info['patient_id']).'/'.$patcon_info['summary_id'].'/'.$patcon_info['summary_id'], 'Continue Consultation started on '.$patcon_info['date_started'], 'target="_blank"');
    } //endif $patcon_info['summary_id'] == "new_summary")
    echo "</span>";
} else {
    echo "\n<p /><span class='simple_button_yellow' >";
    echo "User not authorised to perform consultation";
    echo "</span>";
}
/*
echo "\n<p />";
        ...
        echo "\n<td valign='top' colspan='2'>";
            ...
            echo "\n\n<div id='past_con'>"; // class='overviewblock'
                ...
                if(count($patient_past_con) > 0){
                    ...
                    foreach ($patient_past_con as $consultation){
                        echo "<tr><td valign='top'>";
	                    echo anchor('indv/indv/index/indv_overview/ehr_individual/past_con_details/print_hardcopy/'.trim($consultation['patient_id']).'/'.$consultation['summary_id'].'/html ', 'html', 'target="_blank"');
                        echo "  ";
	                    echo anchor('indv/indv/index/indv_overview/ehr_individual/past_con_details/print_hardcopy/'.trim($consultation['patient_id']).'/'.$consultation['summary_id'].'/pdf ', 'pdf', 'target="_blank"');
                        echo " </td>";
...
//----start
            echo "\n\n<div id='appointments' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_overview/ehr_individual_schedule/indv_edit_queue/new_queue/'.$patient_id.'/new_queue', 'APPOINTMENTS');
                //echo "APPOINTMENTS";
                echo "</div>";
                if(count($queue_info) > 0){
                    ...
                    foreach ($queue_info as $queue_item){
                        ...
                        if($queue_item['clinic_shortname'] == $this->session->userdata('clinic_shortname')){
                            echo anchor('indv/indv/index/indv_overview/ehr_individual_schedule/indv_edit_queue/edit_queue/'.$patient_id.'/'.$queue_item['booking_id'], $queue_item['date']);
                        } else {
                            echo $queue_item['date'];
                        }
                        echo "<t/d>";
                    ...
                    echo "</table>";
        	        echo anchor('indv/indv/index/indv_overview/ehr_individual_schedule/indv_edit_queue/new_queue/'.$patient_id.'/new_queue', 'Add New Appointment');
                } else {
                    echo "\n<br /> None recorded";
...
*/
            echo "\n\n<div id='vitals' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_vitals/list_vitals/'.$patient_id, 'RECENT VITAL SIGNS');
                echo "</div>";
                if(isset($vitals_info['vital_id']) && ($vitals_info['vital_id'] <> "new_vitals")){
                    ...
                    echo "\n<tr>";
                        ...
                        echo "<td></td><td></td><td>";
                        //echo anchor('indv/indv/index/indv_overview/ehr_individual_history/list_history_vitals/'.$patient_id, 'View Charts');
                        echo "</td>";
                        echo "\n<td></td>";
                        echo "<td></td>";
                    echo "\n</tr>";
...
//----start
                ...
                if(count($problem_list) > 0){
                    ...
                    foreach ($problem_list as $problem_item){
                        ...
                        echo "\n<td valign='top'>".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_imagresult/edit_result/'.$patient_id.'/'.$problem_item['problem_list_id'], "<strong>".$problem_item['date']."</strong>")."</td>";
                        echo "<td valign='top'>".$problem_item['staff_initials']."</td>";
                        echo "<td valign='top'>".$problem_item['problem']."</td>";
                        echo "</tr>";
                    }//endforeach;
                    echo "</table>";
                } else {
...
*/
            echo "\n\n<div id='medical_history' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_diagnosis/list_diagnoses/'.$patient_id, 'MEDICAL HISTORY');
                echo "</div>";
...
*/
            echo "\n\n<div id='medication_history' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
	            echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_medication/list_medications/'.$patient_id, 'MEDICATION HISTORY');
                echo "</div>";
                echo "\n<table>";
...
*/
            echo "\n\n<div id='past_procedures' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
	            echo anchor('indv/indv/index/indv_history/ehr_indvhist_procedure/edit_past_procedure/new_procedure/'.$patient_id, 'PAST PROCEDURES');
                echo "</div>";
                if(count($procedure_info) > 0){
                    echo "\n<table>";
                    echo "\n<tr>";
                        ...
                        echo "\n<th>Outcome</th>";
                    echo "</tr>";
                    foreach ($procedure_info as $procedure_item){
                        echo "<tr>";
                        echo "\n<td valign='top'>".anchor('indv/indv/index/indv_history/ehr_indvhist_procedure/edit_past_procedure/edit_procedure/'.$patient_id.'/'.$procedure_item['past_procedure_id'], "<strong>".$procedure_item['pcode1ext_shortname']."</strong>")."</td>";
                        ...
                        //echo "<td valign='top'>".$procedure_item['procedure_date']."</td>";
                        echo "<td valign='top'>".$procedure_item['procedure_place']."</td>";
                        echo "<td valign='top'>".$procedure_item['procedure_outcome']."</td>";
                        echo "</tr>";
                    }//endforeach;
                    echo "</table>";
                } else {
...
/*
        ...
        echo "\n<td valign='top'>";
*/
                echo "\n\n<div id='procedure_orders' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_history/ehr_indvhist_procedure/list_history_procedure_orders/list_orders/'.$patient_id, 'PROCEDURE ORDERS');
                echo "</div>";
                if(count($procedure_orders) > 0){
                    echo "\n<table>";
                    echo "\n<tr>";
                        ...
                        echo "\n<th>Supplier</th>";
                    echo "</tr>";
                    foreach ($procedure_orders as $order_item){
                        echo "<tr>";
                        echo "\n<td valign='top'>".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_imagresult/edit_result/'.$patient_id.'/'.$order_item['order_id'], "<strong>".$order_item['pcode1ext_shortname']."</strong>")."</td>";
                        echo "<td valign='top'>".$order_item['date_started']."</td>";
                        echo "<td valign='top'>".$order_item['notes']."</td>";
...
*/
            echo "\n\n<div id='lab_orders' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
	            echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_lab/list_orders/'.$patient_id, 'LAB ORDERS');
                echo "</div>";
                if(count($lab_info) > 0){
                    echo "\n<table>";
                    echo "\n<tr>";
                    ...
                    foreach ($lab_info as $lab_item){
                        ...
                        echo "\n<td>".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_labresults/edit_labresults/'.$patient_id.'/'.$lab_item['session_id'].'/'.$lab_item['lab_order_id'], "<strong>".$lab_item['package_name']."</strong>")."</td>";
...
*/
                echo "\n\n<div id='imaging_orders' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_imaging/list_orders/'.$patient_id, 'IMAGING ORDERS');
                echo "</div>";
                if(count($imaging_info) > 0){
                    ...
                    foreach ($imaging_info as $imaging_item){
                        echo "<tr>";
                        //echo "<td>".anchor('ehr_patient/edit_/edit_diagnosis/'.$patient_id.'/'.$imaging_item['order_id'], $imaging_item['product_code'])."</td>";
                        echo "\n<td valign='top'>".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_imagresult/edit_result/'.$patient_id.'/'.$imaging_item['order_id'], "<strong>".$imaging_item['component']."</strong>")."</td>";
                        //echo "<td><strong>".$imaging_item['component']."</strong></td>";
                        echo "<td valign='top'>".$imaging_item['date_started']."</td>";
                        echo "<td valign='top'>".$imaging_item['remarks']."</td>";
                        echo "<td valign='top'>".$imaging_item['supplier_name']."</td>";
                        echo "<td valign='top'>".$imaging_item['result_status']."</td>";
                        echo "</tr>";
                    }//endforeach;
                    echo "</table>";
                } else {
...
*/
            echo "\n\n<div id='proc_orders' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_history/ehr_individual_history/list_history_social/list_social/'.$patient_id, 'SOCIAL HISTORY');
                echo "</div>";
                if(count($social_history) > 0){
                    echo "\n<table>";
                    echo "\n<tr><td colspan='2'>Date recorded</td><td>: ".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_history_social/edit_history/'.$patient_id.'/'.$social_history[0]['social_history_id'], $social_history[0]['date'])."</td>";
...
*/
            echo "\n\n<div id='immunisation' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
        	    echo anchor('indv/indv/index/indv_overview/ehr_individual/edithist_immune_select/new_immune/'.$patient_id.'/new_immune', 'IMMUNISATION HISTORY');
                echo "</div>";
                echo "\n<table>";
                echo "\n<tr>";
                    echo "\n<th>Date</th>";
...
*/
            echo "\n\n<div id='antenatal_history' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
	            echo anchor('indv/indv/index/indv_antenatal/ehr_individual_antenatal/list_history_antenatal/list_history/'.$patient_id, 'ANTENATAL HISTORY');
                echo "</div>";
                if(count($history_antenatal) > 0){
                    ...
                    foreach ($history_antenatal as $antenatal_item){
                        ...
                        if($previous_antenatal_id === $antenatal_item['antenatal_id']){
                            ...
                            echo "\n<td>".anchor('indv/indv/index/indv_antenatal/ehr_individual_antenatal/edit_history_antenatal/edit_antenatal/'.$patient_id.'/'.$antenatal_item['antenatal_id'], "<strong>".$antenatal_item['gravida']."</strong>");
...
*/
                ...
                echo "\n<div class='block_title_ovv'>";
	            echo anchor('indv/indv/index/indv_refer/ehr_individual_refer/list_referral_out/list_referrals/'.$patient_id, 'REFERRALS HISTORY');
                echo "</div>";
            ...
            echo "\n\n<div id='vitals' class='overviewblock'>";
                echo "\n<div class='block_title_ovv'>";
                    if(($patient_info['gender'] == "Female") && ($patient_info['fertile'] == "TRUE")){
	                    echo anchor('indv/indv/index/indv_antenatal/ehr_individual_antenatal/list_history_antenatal/list_history/'.$patient_id, 'LAST ANTENATAL CHECKUP');
                    } else {
                        echo "LAST ANTENATAL";
...
$siteurl_medication    =   site_url()."/ehr_ajax/ehr_ajax/show_medication";
$siteurl_immunisation    =   site_url()."/ehr_ajax/ehr_ajax/show_immunisation";
//echo $siteurl;
?>
...
//      url:siteurl+'/ehr_ajax/show_immunisation/'+patient_id,
    ...
    function timed_refresh(timeoutPeriod) {
