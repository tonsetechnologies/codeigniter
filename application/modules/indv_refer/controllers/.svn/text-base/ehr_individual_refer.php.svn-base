 ...
 */
class Ehr_individual_refer extends MX_Controller 
{
    ...
    // === INDIVIDUAL RECORD
    // ------------------------------------------------------------------------
    function list_referral_out($seg3,$seg4)
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_indv_list_referral_out_html";
     ...
     * @author  Jason Tan Boon Teck
     */
    function edit_referral_out($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		...
		if ($this->form_validation->run('edit_referout_response') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_indv_edit_refer_out_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
			...
			$upd_response_array['reply_recorder']   = $this->session->userdata('staff_id');
    ...
    function print_referral_letter($seg3,$seg4,$seg5,$seg6,$seg7,$seg8)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['summary_id']         =   $seg5; //$this->uri->segment(5);
        $data['referral_id']        =   $seg6; //$this->uri->segment(6);
        $data['form_country']       =   $seg7; //$this->uri->segment(7);
        $data['output_format']      =   $seg8; //$this->uri->segment(8);
		//echo "Edit referral";
		$data['title'] = "Referral";
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
			...
			$new_body   =   "ehr_print_referral_letter_html";
			$new_footer =   "ehr/footer_emr_wap";
		} else {
			//$new_header =   "ehr/header_xhtml1-strict";
			$new_header =   "ehr/header_xhtml1-transitional";
        ...
        switch ($data['form_country']){
            ...
            */
            case "PH":
                ...
                $new_body   =   "ehr_print_referral_letter_PH_html";
                break;
...
//$mpdf->WriteHTML('Your Book text');
     ...
     * @author  Jason Tan Boon Teck
     */
    function draft_notify_email($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		//$this->load->model('morders_wdb');
		...
		if ($this->form_validation->run('edit_referout_email') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
                //$new_body   =   "ehr/ehr_orders_edit_imagresult_wap";
                $new_body   =   "ehr_indv_refer_email_draft_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
			...
			$upd_email_array['reply_recorder']   = $this->session->userdata('staff_id');
    ...
    function send_email($email_array)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_indv_refer_email_sent_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
     ...
     * @author  Jason Tan Boon Teck
     */
    function check_remote_patient_existence($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		//$this->load->model('morders_wdb');
        ...
        //echo "remote_site_path= ".$remote_site_path ;
        ...
        //echo "<br />curled = ".$data['curled']; // This is the result returned by the remote server
        ...
        if(isset($data['xml_array']['check_stats']['exact_match'])){
        ...
        if(isset($data['xml_array']['check_stats']['partial_match'])){
...
`       */
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
            //$new_body   =   "ehr/ehr_orders_edit_imagresult_wap";
            $new_body   =   "ehr_indv_refer_patient_existence_html";
            $new_footer =   "ehr/footer_emr_wap";
        } else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
     ...
     * @author  Jason Tan Boon Teck
     */
    function send_referral_out2server_confirm($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		//$this->load->model('morders_wdb');
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
            //$new_body   =   "ehr/ehr_orders_edit_imagresult_wap";
            $new_body   =   "ehr_indv_refer_out2server_confirm_html";
            $new_footer =   "ehr/footer_emr_wap";
        } else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
     ...
     * @author  Jason Tan Boon Teck
     */
    function send_referral_out2server_done($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		//$this->load->model('morders_wdb');
        ...
        $data['now_date']           =   date("Y-m-d",$data['now_id']);
        $data['now_time']           =   date("H:i",$data['now_id']);
        $export_by 		= $this->session->userdata('staff_id');
        ...
        $xmlstr .= "\n<THIRRA_refer_out>";
            ...
            $xmlstr .= "\n\t\t<export_clinicid>".$this->session->userdata('location_id')."</export_clinicid>";
            $xmlstr .= "\n\t\t<export_remarks>".$data['export_remarks']."</export_remarks>";
            $xmlstr .= "\n\t\t<export_username>".$this->session->userdata('username')."</export_username>";
        ...
        $remote_site_path   =   $data['remote_site']."index.php/ehr_refer_curl";
        //$remote_site_path   =   "http://192.168.0.21/thirra/index.php/ehr_refer_curl";
        //echo "<br />data['remote_site']=".$data['remote_site'];
        //$this->curl->create($remote_site_path.'/curled.php');
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
            //$new_body   =   "ehr/ehr_orders_edit_imagresult_wap";
            $new_body   =   "ehr_indv_refer_out2server_done_html";
            $new_footer =   "ehr/footer_emr_wap";
        } else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
	function refer_select_details($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['medication_info']  = $this->mindiv_rdb->get_recent_medication($data['patient_id']);
        ...
        $data['diagnoses_info']  = $this->mindiv_rdb->get_recent_diagnoses($data['patient_id']);
		...
		*/
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_refer_select_details_html";
    ...
    function refer_export_detailsdone($id=NULL)  // template for new classes
    {
            ...
            */
			...
			//for($i=1; $i<=$data['num_rows']; $i++){
				...
				//if(isset($_POST['s'.$i])){
					...
					$data['unsynched_list'][$selected]['lab_list']       = $this->mindiv_rdb->get_recent_lab($data['patient_id']);
					$data['unsynched_list'][$selected]['imaging_list']   = $this->mindiv_rdb->get_recent_imaging($data['patient_id']);
					$data['unsynched_list'][$selected]['diagnosis_list'] = $this->mindiv_rdb->get_recent_diagnoses($data['patient_id']);
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_sidebar=   "ehr/sidebar_emr_admin_wap";
            $new_body   =   "ehr_refer_export_detailsdone_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    function admin_import_new_refer_review($id=NULL)  // template for new classes
    {
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_banner =   "ehr/banner_ehr_html";
            $new_sidebar=   "ehr/sidebar_emr_admin_html";
            $new_body   =   "ehr_refer_import_review_html";
            $new_footer =   "ehr/footer_emr_html";
		}
    ...
    function admin_import_new_refer_insertpatient($id=NULL)  // template for new classes
    {
        ...
        if(count($_POST)) {
            ...
            $data['init_clinic_home']       =   $this->session->userdata('location_id');//$this->input->post('clinic_home');
            $data['init_clinic_registered']     =   $this->session->userdata('location_id');
            ...
            $ins_log_array['import_by']         = $this->session->userdata('staff_id');
    ...
    function admin_import_new_referview($filename,$callerdata)  // called by other methods
    {
        ...
        //if(count($_POST)) {
			...
			foreach ($xml->clinical_episode as $item) {
                ...
                $data['same_patient_id'] = $this->mrefer_rdb->get_patients_listby_anything('All','name','patient_id',$data['unsynched_list'][$i]['patient_id']);
                $data['same_birthdate'] = $this->mrefer_rdb->get_patients_listby_anything('All','name','birth_date',$data['unsynched_list'][$i]['birth_date']);
                if(!empty($data['unsynched_list'][$i]['ic_no'])){
                    $data['same_ic_no'] = $this->mrefer_rdb->get_patients_listby_anything('All','name','ic_no',$data['unsynched_list'][$i]['ic_no']);
                }
                if(isset($data['unsynched_list'][$i]['pns_pat_id'])){
                    $data['same_pns_pat_id'] = $this->mrefer_rdb->get_patients_listby_anything('All','name','pns_pat_id',$data['unsynched_list'][$i]['pns_pat_id']);
                }
                if(!empty($data['unsynched_list'][$i]['nhfa_no'])){
                    $data['same_nhfa_no'] = $this->mrefer_rdb->get_patients_listby_anything('All','name','nhfa_no',$data['unsynched_list'][$i]['nhfa_no']);
                }
