...
echo "\n<u>Form 8</u>: Referral Form";
echo "<hr />";

echo "\n<table class='valigntop' width='100%'>";
echo "\n<tr>";
	echo "<td align='center' width='100%'>Republic of the Philippines</td>";
echo '</tr>';
echo "\n<tr>";
	echo "<td align='center'>Province of Quezon</td>";
echo '</tr>';
echo "\n<tr>";
	echo "<td align='center'><strong>Two-Way Clinical Referral Form</strong></td>";
echo '</tr>';
echo '</table>';
...
echo "\n<tr>";
	echo "\n<td>";
    echo "Priority/Emergency Referral";
	echo "</td>";
	echo "\n<td>";
    echo "Outpatient Referral";
	echo "</td>";
	echo "\n<td>";
    echo "Hospital Case #:";
	echo "</td>";
echo '</tr>';
echo "\n<tr>";
	echo "<td><strong>Referred to:";
        echo $referral_info[0]['referral_centre'];
	echo "</strong></td>";
	echo "<td><strong>Referred from:";
        echo $referral_info[0]['referral_centre'];
	echo "</strong></td>";
echo '</tr>';
echo "\n<tr>";
