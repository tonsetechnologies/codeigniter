...
echo "\nExported to this XML file named <a href='http://".$_SERVER["SERVER_ADDR"]."/".$app_folder."-uploads/exports_refer/".$file_exported."' target='_blank'>$file_exported</a>.";
