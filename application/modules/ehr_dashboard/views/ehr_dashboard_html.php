...
if($debug_mode) {
    ...
    */
    ...
    echo "\n<br />print_r(user_rights)=<br />";
		print_r($user_rights);
    echo "\n<br />print_r(acl_panel)=<br />";
		print_r($acl_panel);
	echo '</pre>';
    echo "</p>";
    echo "\n</div>";
}
// Experimental ACL panels
//echo "\n<table border='1'>";
foreach($acl_panel as $acl_item){
    if($acl_item['rights_single'] > 0){
        echo "\n\n<div class='section'>";
        echo "<td width='800'><h2>";
...
echo "\n\n<div id='patient_queue' class='section'>";
	...
	echo "\n<div class='section_body'>";
        ...
        foreach ($queue_info as $queue_item){
            ...
            echo "<td>&nbsp;".anchor('indv/indv/index/indv_overview/ehr_individual/individual_overview/overview/'.$queue_item['patient_id'].'/'.$queue_item['booking_id'], $queue_item['name'].", ".$queue_item['name_first']." (".$queue_item['birth_date'].")", "target='_blank'")."</td>";
...
echo "\n\n<div id='lab_orders' class='section'>";
    ...
    if(isset($lab_orders)){
        ...
        foreach($lab_orders as $lab_item){
            ...
            echo "<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders/edit_labresults/edit_labresults/'.$lab_item['patient_id'].'/'.$lab_item['session_id'].'/'.$lab_item['lab_order_id'], $lab_item['name'])."</td>";
