    ...
    if(isset($pending_referrals)){
        ...
        foreach($pending_referrals as $referral_item){
            echo "\n<tr>";
	            ...
	            echo anchor('indv/indv/index/indv_overview/ehr_individual/individual_overview/overview/'.$referral_item['patient_id'], "<strong>".$referral_item['name']."</strong>, ".$referral_item['name_first'], 'target="_blank"');
                echo "</td>";
