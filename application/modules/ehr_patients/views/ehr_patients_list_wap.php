...
if(count($patlist) > 0) {
    ...
    foreach ($patlist as $patient){
        echo "\n<tr>";
            ...
            /*
            echo "\n<td>";
        	echo anchor('ehr_individual/hardcopy_patient_booklet/'.trim($patient['patient_id']).'/html ', 'html', 'target="_blank"');
            echo "</td>";
            echo "\n<td>";
        	echo anchor('ehr_individual/hardcopy_patient_booklet/'.trim($patient['patient_id']).'/pdf ', 'pdf', 'target="_blank"');
            echo "</td>";
            echo "<td>";
