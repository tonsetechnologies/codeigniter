...
echo "</strong></p>";
    ...
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$location_id.'/name/All', ' All ');
	echo "</p>";
...
if(count($patlist) > 0) {
    ...
    echo "<tr>";
        echo "\n<th>No.</th>";
        echo "\n<th width='120'>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/birth_date/'.$alphabet, 'Birth Date');
        echo "</th>";
        echo "\n<th width='300'>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/name/'.$alphabet, 'Patient Name');
        echo "</th>";
        echo "\n<th>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/gender/'.$alphabet, 'Sex');
        echo "</th>";
        echo "\n<th>Add to</th>";
        echo "<th></th>";
        echo "\n<th>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/clinic_reference_number/'.$alphabet, 'Ref.');
        echo "</th>";
        echo "\n<th>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/ic_no/'.$alphabet, 'NRIC');
        echo "</th>";
        echo "\n<th colspan='2'>Booklet</th>";
        echo "\n<th>";
    	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/'.$patient_scope.'/clinic_home/'.$alphabet, 'Home Clinic');
        echo "</th>";
        echo "<th></th>";
    echo "</tr>";
    $row_num = 1;
    foreach ($patlist as $patient){
        echo "\n<tr>";
            ...
            echo "</td>";
            echo "\n<td>";
        	echo anchor('indv/indv/index/indv_overview/ehr_individual/hardcopy_patient_booklet/print_hardcopy/'.trim($patient['patient_id']).'/html ', 'html', 'target="_blank"');
            echo "</td>";
            echo "\n<td>";
        	echo anchor('indv/indv/index/indv_overview/ehr_individual/hardcopy_patient_booklet/print_hardcopy/'.trim($patient['patient_id']).'/pdf ', 'pdf', 'target="_blank"');
            echo "</td>";
            echo "<td>";
...
echo "All clinics:";
	echo "\n<p>";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/A', ' A ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/B', ' B ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/C', ' C ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/D', ' D ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/E', ' E ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/F', ' F ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/G', ' G ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/H', ' H ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/I', ' I ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/J', ' J ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/K', ' K ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/L', ' L ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/M', ' M ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/N', ' N ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/O', ' O ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/P', ' P ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/Q', ' Q ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/R', ' R ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/S', ' S ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/T', ' T ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/U', ' U ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/V', ' V ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/W', ' W ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/X', ' X ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/Y', ' Y ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/Z', ' Z ');
    echo "\n| ";
	echo anchor('ehr/ehr/index/ehr_patients/ehr_patient/patients_list/all/name/All', ' All ');
	echo "</p>";
