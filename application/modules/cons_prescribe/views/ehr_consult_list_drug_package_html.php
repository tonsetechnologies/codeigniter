...
if(isset($packages_list)){
    ...
    foreach ($packages_list as $package_item){
        ...
        echo "\n<td valign='top'>".anchor('cons/cons/index/cons_prescribe/ehr_consult_prescribe/edit_drug_package/edit_package/'.$patient_id.'/'.$summary_id.'/'.$package_item['drug_package_id'], $package_item['package_name'])."</td>";
