...
foreach ($prescribe_list as $prescribe_item){
    ...
    $delete_link    =   base_url()."index.php/cons/cons/index/cons_prescribe/ehr_consult_prescribe/consult_delete_prescription/".$patient_id."/".$summary_id."/".$prescribe_item['queue_id'];
...
echo form_open('cons/cons/index/cons_prescribe/ehr_consult_prescribe/edit_prescribe_package/'.$form_purpose.'/'.$drug_package_id, $attributes);
