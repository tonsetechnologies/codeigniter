...
foreach ($prescribe_list as $prescribe_item){
    echo "\n<tr>";
    echo "<td>".anchor('cons/cons/index/cons_prescribe/ehr_consult_prescribe/edit_immune_prescribe/edit_prescribe/'.$patient_id.'/'.$summary_id.'/'.$prescribe_item['queue_id'], $prescribe_item['generic_name'])."</td>";
...
echo form_open('cons/cons/index/cons_prescribe/ehr_consult_prescribe/edit_immune_prescribe/new_immune/'.$patient_id, $attributes);
        ...
        if($current_column > $previous_column){
            if($vaccine['age_group'] == $age_column){
                if(isset($vaccine['date'])){
                    ...
                    echo "<strong>";
                	echo anchor('cons/cons/index/cons_prescribe/ehr_consult_prescribe/edit_immune_prescribe/new_immune/'.$patient_id.'/'.$summary_id.'/'.trim($vaccine['immunisation_id']), 'Select');
                    echo "</strong>";
                }
                echo "\n<br />".$vaccine['dose'];
                if($debug_mode){
