...
if(isset($tests_list)){
    ...
    foreach ($tests_list as $lab_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('indv/indv/index/indv_history/ehr_individual_history/edit_labresults/edit_labresults/'.$patient_id.'/'.$lab_item['session_id'].'/'.$lab_item['lab_order_id'], "<strong>".$lab_item['sample_date']."</strong>")."</td>";
