...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('patients_edit_history_vitals_html_title')."</h1></div>";

//echo validation_errors(); Displays ALL errors in one place.
echo "\n<h2>".$save_attempt."</h2>";
$attributes =   array('class' => 'select_form', 'id' => 'vitals_form');
echo form_open('indv/indv/index/indv_history/ehr_individual_history/edit_history_vitals/new_vitals/'.$patient_id, $attributes);
echo "\n<table>";
