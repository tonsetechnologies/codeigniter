...
*/
echo "\n<tr>";
    echo "<td width='25%'>Supplier Name</td><td>";
    echo $supplier_name;
    echo "</td>";
echo "</tr>";
echo "\n<tr>";
...
echo form_open('indv/indv/index/indv_history/ehr_individual_history/edit_imagresult/edit_result/'.$form_purpose.'/'.$order_id);
...
echo "\n<input type='text' name='result_date' value='".set_value('result_date',$init_result_date)."' size='10' id='result_datepicker' /> YYYY-MM-DD</td></tr>";

echo "\n<tr><td>Results Reference</td><td>";
echo form_error('result_ref');
echo "\n<input type='text' id='result_ref' name='result_ref' value='".set_value('result_ref',$init_result_ref)."' size='20' /></td></tr>";
...
echo "\n<input type='text' id='result_remarks' name='result_remarks' value='".set_value('result_remarks',$init_result_remarks)."' size='80' /></td></tr>";
