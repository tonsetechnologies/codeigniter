...
foreach ($referrals_list as $referral_item){
    echo "<tr>";
    echo "<td>".anchor('cons/cons/index/cons_progress/ehr_consult/edit_referral/edit_referral/'.$patient_id.'/'.$summary_id.'/'.$referral_item['referral_id'], $referral_item['doctor_name'])."</td>";
    ...
    //echo "<td>".anchor('cons/cons/index/cons_progress/ehr_consult/print_referral_letter/'.$referral_item['referral_id'], 'Print', 'target="_blank"')."</td>";
...
//echo anchor('cons/cons/index/cons_progress/ehr_consult/edit_referral/new_referral/'.$patient_id.'/'.$summary_id.'/new_referral', 'Add More Referral');

$attributes =   array('class' => 'select_form', 'id' => 'referral_form');
echo form_open('cons/cons/index/cons_progress/ehr_consult/edit_referral/'.$form_purpose.'/'.$patient_id.'/'.$summary_id, $attributes);
...
echo "\n<input type='text' name='referral_date' value='".set_value('referral_date',$init_referral_date)."' size='10' /></td></tr>";

echo "\n<tr>";
    echo "\n<td width='25%' valign='top'>Referral Reason <font color='red'>*</font></td>";
    echo "\n<td>";
    echo form_error('reason');
    echo "\n<textarea class='normal' name='reason' id='diagnosis' rows='8' cols='50'>".set_value('reason',$init_reason)."</textarea>";
    echo "\n</td>";
echo "\n</tr>";

echo "\n<tr>";
    echo "\n<td width='25%' valign='top'>Clinical Examination</td>";
    echo "\n<td>";
    echo form_error('clinical_exam');
    echo "\n<textarea class='normal' name='clinical_exam' id='diagnosis2' rows='8' cols='50'>".set_value('clinical_exam',$init_clinical_exam)."</textarea>";
    echo "\n</td>";
echo "\n</tr>";
