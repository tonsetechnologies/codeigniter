    ...
    foreach ($modules_list as $module){
        ...
        echo "\n<tr>";
            ...
            if(
                ...
                echo anchor('cons/cons/index/cons_gem/ehr_consult_gem/list_gem_submodules/list_submodules/'.$patient_id.'/'.$summary_id.'/'.$module['gem_module_id'], '<strong>'.$module['gem_module_pcurltext'].'</strong>');
