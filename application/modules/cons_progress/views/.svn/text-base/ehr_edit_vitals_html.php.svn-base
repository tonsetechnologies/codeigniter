...
echo form_open('cons/cons/index/cons_progress/ehr_consult/edit_vitals/edit_vitals/'.$patient_id.'/'.$summary_id, $attributes);
echo "\n<table>";
...
echo "\n<fieldset>";
echo "<legend>VITAL SIGNS HISTORY</legend>";
//echo "<strong>Add New Reading</strong>";
echo anchor('indv/indv/index/indv_history/ehr_individual_history/edit_history_vitals/new_vitals/'.$patient_id, "<strong>Add New Reading</strong>");
echo "\n<br /><br />";
