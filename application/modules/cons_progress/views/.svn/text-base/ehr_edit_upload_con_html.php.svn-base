...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('patients_edit_upload_file_html_title')."</h1></div>";

echo "\n<p></p>";
echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";


echo form_open_multipart('cons/cons/index/cons_progress/ehr_consult/upload_pics_con/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/new_referral');
