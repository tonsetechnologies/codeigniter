...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('util_list_procedure_group_html_title')."</h1></div>";

echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";

echo "\n<fieldset>";
echo "<legend>PROCEDURE GROUP LIST</legend>";
echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes_procedures/util_edit_procedure_group/new_code/new_code', "<strong>Add New Procedure  Group</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    ...
    echo "</th>";
    echo "\n<th width='500'>";
	echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_list_diagnosiscodes/full_title/0', 'Procedure Group');
    echo "</th>";
...
if(isset($diagnosis_list)){
    ...
    for ($i=0; $i < $per_page; $i++){
        ...
        echo "\n<td valign='top'><strong>".$diagnosis_list[$i]['pcode1_code']."</strong></td>";
        echo "\n<td valign='top'>".anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes_procedures/util_list_procedure_codes_pergroup/pcode1ext_code/'.$diagnosis_list[$i]['pcode1_id'], $diagnosis_list[$i]['full_title'])."</td>";
        echo "\n<td valign='top'>".$diagnosis_list[$i]['pcode_category']."</td>";
        echo "\n</tr>";
        $rownum++;
    }//endforeach;
}
