...
echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_geo/util_edit_state_info/new_state/new_state', "<strong>Add New State</strong>");
echo "\n<br /><br />";
...
echo "\n<tr>";
    echo "\n<th>No.</th>";
    echo "\n<th width='110'>";
	echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_geo/util_list_addrstates/addr_state_code', 'Code');
    echo "</th>";
    echo "\n<th width='300'>";
	echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_geo/util_list_addrstates/addr_state_name', 'State Name');
    echo "</th>";
    echo "\n<th width='200'>";
	echo anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_geo/util_list_addrstates/addr_state_country', 'Country');
    echo "</th>";
    echo "\n<th width='50'>Sort</th>";
...
if(isset($state_list)){
    ...
    foreach ($state_list as $state_item){
        ...
        echo "\n<td>".anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_geo/util_edit_state_info/edit_state/'.$state_item['addr_state_id'], "<strong>".$state_item['addr_state_name']."</strong>")."</td>";
