...
echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_drugatc/'.$form_purpose.'/'.$atc_code, $attributes);
...
if(isset($same_chemical)){
    ...
    foreach($same_chemical as $similar_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_drugatc/edit_code/'.$similar_item['atc_code'], "<strong>".$similar_item['atc_code']."</strong>")."</td>";
