...
echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_drugcode/'.$form_purpose.'/'.$drug_code_id, $attributes);
...
if(isset($formulary_info[0])){
    ...
    echo "\n<tr>";
        ...
        echo "\n<td>".anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_drugformulary/edit_formulary/'.$formulary_info[0]['drug_formulary_id'], $formulary_info[0]['generic_name'])."</td>";
    echo "\n</tr>";
    echo "\n<tr>";
    ...
    foreach ($drugcode_list as $drugcode_item){
        echo "\n<li>[".$drugcode_item['drug_code']."] ".anchor('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_drugcode/edit_drugcode/'.$drugcode_item['drug_code_id'], $drugcode_item['trade_name'])."</li>";
    }//endforeach;
    echo "\n</ol>";
