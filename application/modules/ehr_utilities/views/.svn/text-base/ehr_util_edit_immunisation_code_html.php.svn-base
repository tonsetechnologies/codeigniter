...
echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_immunisation_code/'.$form_purpose.'/'.$immunisation_id, $attributes);
...
if($form_purpose == "edit_code"){
    ...
    echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_immunisation_drug/'.$form_purpose.'/'.$immunisation_id, $attributes);
