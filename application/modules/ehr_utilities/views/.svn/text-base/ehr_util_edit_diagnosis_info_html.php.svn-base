...
if($debug_mode) {
    ...
    echo "\n<br />dcode1set=".$init_dcode1set;
    echo "\n<br />dcode1_code=".$init_dcode1_code;
    echo "\n</div>";
}
...
echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_diagnosis_info/'.$form_purpose.'/'.$init_dcode1_id, $attributes);
...
echo "\n<input type='text' name='dcode1_code' value='".set_value('dcode1_code',$init_dcode1_code)."' size='10' /></td></tr>";
