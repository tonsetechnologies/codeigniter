...
echo form_open('ehr/ehr/index/ehr_utilities/ehr_utilities_codes/util_edit_diagnosisext_info/'.$form_purpose.'/'.$init_dcode1_id.'/'.$dcode1ext_id, $attributes);

echo form_hidden('form_purpose', $form_purpose);
echo form_hidden('now_id', $now_id);
echo form_hidden('dcode1ext_id', $dcode1ext_id);
echo form_hidden('dcode1_id', $init_dcode1_id);
