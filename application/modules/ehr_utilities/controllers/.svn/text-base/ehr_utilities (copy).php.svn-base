 ...
 */
class Ehr_utilities extends MX_Controller 
{
    ...
    function util_edit_village_info($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrvillages/addr_village_sort','List Villages');    
		...
		if ($this->form_validation->run('edit_addr_village') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrvillages/addr_village_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_town_info($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrtowns/addr_town_sort','List Towns');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_addr_town') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrtowns/addr_town_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_area_info($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrareas/addr_area_sort','List Areas');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_addr_area') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrareas/addr_area_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_district_info($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrdistricts/addr_district_sort','List Districts');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_addr_district') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrdistricts/addr_district_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_state_info($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrstates/addr_state_sort','List States');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_addr_state') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_addrstates/addr_state_sort";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_list_complaint_codes($seg3, $seg4)  // template for new classes
    {
        ...
        $config['base_url'] = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_complaint_codes/".$data['sort_order']."/";
    ...
    function util_edit_complaint_code($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_complaint_codes/icpc_code/0','List Complaint Codes');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_complaint_code') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_complaint_codes/icpc_code/0";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_list_diagnosiscodes($seg3, $seg4)  // template for new classes
    {
        ...
        $config['base_url'] = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_diagnosiscodes/".$data['sort_order']."/";
        $config['total_rows']   = $data['count_fulllist'];
        $config['per_page']     = $data['per_page'];
        $config['num_links']    = 10;
        $config['uri_segment']  = 4;
    ...
    function util_edit_diagnosis_info($seg3, $seg4)
    {
		...
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_diagnosiscodes/dcode1_code/0','List Diagnosis Codes');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
    ...
    function util_edit_diagnosisext_info($seg3, $seg4, $seg5)
    {
		...
		if ($this->form_validation->run('edit_diagnosisext_code') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_diagnosisext_codes/dcode1ext_code/".$data['dcode1_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_drugatc($seg3, $seg4)
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drugatc/atc_code/0','List ATC Drug Codes');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_drug_atc') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drugatc/atc_code/0";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_list_drugformulary($seg3, $seg4)  // template for new classes
    {
        ...
        $config['base_url'] = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drugformulary/".$data['sort_order']."/";
        $config['total_rows']   = $data['count_fulllist'];
        $config['per_page']     = $data['per_page'];
        $config['num_links']    = 10;
        $config['uri_segment']  = 4;
    ...
    function util_edit_drugformulary($seg3, $seg4, $seg5)
    {
		...
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drugformulary/formulary_code/0','List Drug Formularies');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_drug_formulary') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities//util_list_drugformulary/commonly_used/0";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_list_drug_codes($seg3, $seg4)  
    {
        ...
        $config['base_url'] = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drug_codes/".$data['sort_order']."/";
        $config['total_rows']   = $data['count_fulllist'];
        $config['per_page']     = $data['per_page'];
        $config['num_links']    = 10;
        $config['uri_segment']  = 4;
    ...
    function util_edit_drugcode($seg3, $seg4)
    {
		...
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drug_codes/drug_code/0','List Drug Codes');    
        $data['form_purpose']   	= 	$seg3; //$this->uri->segment(3);
		...
		if ($this->form_validation->run('edit_drug_code') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_drug_codes/commonly_used/0";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_list_immunisation_codes($seg3, $seg4)  // template for new classes
    {
        ...
        $config['base_url'] = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_immunisation_codes/".$data['sort_order']."/";
        $config['total_rows']   = $data['count_fulllist'];
        $config['per_page']     = $data['per_page'];
        $config['num_links']    = 10;
        $config['uri_segment']  = 4;
    ...
    function util_edit_immunisation_code($seg3, $seg4)
    {
		...
		if ($this->form_validation->run('edit_immunisation_code') == FALSE){
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_immunisation_codes/immunisation_sort/0";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function util_edit_immunisation_drug()
    {
        ...
        $data['app_country']		=	$this->config->item('app_country');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr/ehr/index/ehr_utilities/ehr_utilities/utilities_mgt','Utilities','ehr/ehr/index/ehr_utilities/ehr_utilities/util_list_immunisation_codes/immunisation_sort/0','List Immunisation Codes');    
