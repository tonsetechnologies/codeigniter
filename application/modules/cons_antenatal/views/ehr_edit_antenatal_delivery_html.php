...
echo form_open('cons/cons/index/cons_antenatal/ehr_consult_antenatal/edit_antenatal_delivery/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$antenatal_id.'/'.$antenatal_delivery_id, $attributes);
echo "\n<table>";
...
echo "\n<tr>";
    ...
    if(isset($init_child_id)) {
        echo "\n&nbsp;&nbsp;";
        echo anchor('indv/indv/index/indv_overview/ehr_individual/individual_overview/overview/'.$init_child_id, "<strong>View Child</strong>", 'target="_blank"');
    }
    echo "\n</td>";
echo "\n</tr>";
} else {
