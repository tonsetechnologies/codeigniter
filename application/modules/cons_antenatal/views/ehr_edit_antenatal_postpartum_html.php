...
if($debug_mode) {
	...
	echo '<pre>';
    echo "\n<br />print_r(postpartum_info)=<br />";
		print_r($postpartum_info);
...
if(isset($postpartum_info[0]['session_id'])){
    if($postpartum_info[0]['session_id'] <> $summary_id){
...
if(isset($postpartum_list)){
    ...
    foreach ($postpartum_list as $postpartum_item){
        ...
        if($antenatal_postpartum_id == $postpartum_item['antenatal_postpartum_id']){
            ...
            echo "\n<td>".anchor('cons/cons/index/cons_antenatal/ehr_consult_antenatal/edit_antenatal_postpartum/edit_postpartum/'.$patient_id.'/'.$summary_id.'/'.$antenatal_id.'/'.$postpartum_item['antenatal_postpartum_id'], "<strong>".$postpartum_item['care_date']."</strong>")."</td>";
...
echo form_open('cons/cons/index/cons_antenatal/ehr_consult_antenatal/edit_antenatal_postpartum/'.$form_purpose.'/'.$patient_id.'/'.$summary_id.'/'.$antenatal_id.'/'.$antenatal_postpartum_id, $attributes);
echo "\n<table>";
...
echo "\n<select class='normal' name='vaginal_discharge'>";          
    ...
    echo "\n<option value='Heavy' ".($init_vaginal_discharge=='Heavy'?"selected='selected'":"").">Heavy - Refer to Physician/RHU</option>";
echo "\n</select>";
echo "\n</td>";
echo "\n</tr>";
...
echo "\n<select class='normal' name='vaginal_bleeding'>";          
    ...
    echo "\n<option value='Heavy' ".($init_vaginal_bleeding=='Heavy'?"selected='selected'":"").">Heavy - Refer to Physician/RHU</option>";
echo "\n</select>";
echo "\n</td>";
echo "\n</tr>";
...
echo "\n<select class='normal' name='pallor'>";          
    ...
    echo "\n<option value='Yes' ".($init_pallor=='Yes'?"selected='selected'":"").">Yes - Refer to Physician/RHU</option>";
echo "\n</select>";
echo "\n</td>";
echo "\n</tr>";
...
if($save_attempt == "VIEW ANTENATAL POSTPARTUM"){
    echo "[ VIEW ONLY ]";
} else {
