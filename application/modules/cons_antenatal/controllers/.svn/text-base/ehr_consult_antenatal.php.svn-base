 ...
 */
class Ehr_consult_antenatal extends MX_Controller 
{
    ...
    // ------------------------------------------------------------------------
    function edit_antenatal_info($seg3,$seg4,$seg5,$seg6) 
    {
		...
		if ($this->form_validation->run('edit_antenatal_info') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_edit_antenatal_info_html";
    ...
    // ------------------------------------------------------------------------
    function edit_antenatal_followup($seg3,$seg4,$seg5,$seg6,$seg7) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['antenatal_followup_id']=   $seg7; //$this->uri->segment(7);
        ...
        if(count($_POST)) {
            ...
            if ($data['form_purpose'] == "new_followup") {
                ...
                $data['init_record_date']   =   $data['now_date'];
                $data['broken_lmp']         =   break_date($data['antenatal_info'][0]['lmp']);
		...
		if ($this->form_validation->run('edit_antenatal_followup') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_conslt_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_conslt_wap";
                $new_body   =   "ehr_edit_antenatal_followup_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/cons/cons/index/cons_antenatal/ehr_consult_antenatal/edit_antenatal_info/edit_antenatal/".$data['patient_id']."/".$data['summary_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function edit_antenatal_delivery($seg3,$seg4,$seg5,$seg6,$seg7) 
    {
        ...
        $data['summary_id']         =   $seg5; //$this->uri->segment(5);
        $data['antenatal_id']       =   $seg6; //$this->uri->segment(6);
        $data['antenatal_delivery_id']=   $seg7; //$this->uri->segment(7);
        $patient_id         =   $data['patient_id'];
        $data['init_patient_id']    =   $patient_id;
		//$data['clinic_info']    = $this->mbio->get_clinic_info($this->session->userdata('location_id'));
		$data['patient_info'] = $this->memr_rdb->get_patient_demo($data['patient_id']);
		...
		if ($this->form_validation->run('edit_antenatal_delivery') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_conslt_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_conslt_wap";
                $new_body   =   "ehr_edit_antenatal_delivery_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function edit_antenatal_postpartum($seg3,$seg4,$seg5,$seg6,$seg7) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['title']              = 'Antenatal Follow-up';
		...
		if ($this->form_validation->run('edit_antenatal_postpartum') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_conslt_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_conslt_wap";
                $new_body   =   "ehr_edit_antenatal_postpartum_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
