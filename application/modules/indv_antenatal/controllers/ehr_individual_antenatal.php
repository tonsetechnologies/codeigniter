 ...
 */
class Ehr_individual_antenatal extends MX_Controller 
{
    ...
    // ------------------------------------------------------------------------
    function edit_history_antenatal($seg3,$seg4,$seg5) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['patient_id']         =   $seg4; //$this->uri->segment(4);
		$data['antenatal_id']       =   $seg5; //$this->uri->segment(5);
		...
		if ($this->form_validation->run('edit_history_antenatal_info') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_ovrvw_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
                $new_body   =   "ehr_indv_edit_history_antenatal_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_antenatal") {
                ...
                $ins_antenatal_array['staff_id']           = $this->session->userdata('staff_id');
                ...
                $ins_antenatal_array['location_id']         = $this->session->userdata('location_id');
                ...
                $upd_antenatal_array['staff_id']           = $this->session->userdata('staff_id');
                ...
                $upd_antenatal_array['update_by']                = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/indv/indv/index/indv_antenatal/ehr_individual_antenatal/list_history_antenatal/list_history/".$data['init_patient_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function status_history_antenatal($seg3,$seg4,$seg5,$seg6,$seg7) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['patient_id']         =   $seg4; //$this->uri->segment(4);
        $data['antenatal_id']       =   $seg5; //$this->uri->segment(5);
        $data['antenatal_info_id']  =   $seg6; //$this->uri->segment(6);
        $data['antenatal_current_id']=   $seg7; //$this->uri->segment(7);
        $data['now_id']             =   time();
        ...
        $new_page = base_url()."index.php/indv/indv/index/indv_antenatal/ehr_individual_antenatal/list_history_antenatal/list_history/".$data['patient_id'];
        header("Status: 200");
        header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function edit_history_antenatal_followup($seg3,$seg4,$seg5,$seg6) 
    {
		$this->load->model('mantenatal_wdb');
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['patient_id']         =   $seg4; //$this->uri->segment(4);
        $data['antenatal_id']       =   $seg5; //$this->uri->segment(5);
        $data['antenatal_followup_id']  =   $seg6; //$this->uri->segment(6);
		...
		if ($this->form_validation->run('edit_antenatal_followup') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_ovrvw_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
                $new_body   =   "ehr_indv_edit_his_antenatal_followup_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['antenatal_followup_id'] == "new_followup") {
                ...
                $ins_followup_array['staff_id']     = $this->session->userdata('staff_id');
                ...
                $upd_followup_array['staff_id']           = $this->session->userdata('staff_id');
                ...
                $upd_followup_array['update_by']                = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/indv/indv/index/indv_antenatal/ehr_individual_antenatal/edit_history_antenatal/edit_history/".$data['patient_id']."/".$data['antenatal_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function edit_history_antenatal_delivery($seg3,$seg4,$seg5,$seg6) 
    {
		//$this->load->model('mantenatal_wdb');
        ...
        $data['patient_id']         =   $seg4; //$this->uri->segment(4);
        $data['antenatal_id']       =   $seg5; //$this->uri->segment(5);
        $data['antenatal_delivery_id']=   $seg6; //$this->uri->segment(6);
        $patient_id                 =   $data['patient_id'];
        $data['init_patient_id']    =   $patient_id;
		//$data['clinic_info']    = $this->mbio->get_clinic_info($this->session->userdata('location_id'));
		$data['patient_info']       = $this->memr_rdb->get_patient_demo($data['patient_id']);
        ...
        if($data['patient_info']['family_link'] == "Head of Family" ){
            ...
            $data['family_below']  = $this->mfamily_rdb->get_family_relations('List','below',$data['family_head']);
        }
		...
		if ($this->form_validation->run('edit_antenatal_delivery') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_ovrvw_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
                $new_body   =   "ehr_indv_edit_his_antenatal_delivery_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['antenatal_delivery_id'] == "new_delivery") {
                ...
                $ins_delivery_array['staff_id']         = $this->session->userdata('staff_id');
                ...
                $upd_delivery_array['staff_id']           = $this->session->userdata('staff_id');
    ...
    // ------------------------------------------------------------------------
    function edit_history_antenatal_postpartum($seg3,$seg4,$seg5,$seg6,$seg7) 
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        ...
        $data['antenatal_id']       =   $seg6; //$this->uri->segment(6);
        $data['antenatal_postpartum_id']=   $seg7; //$this->uri->segment(7);
        $patient_id                 =   $data['patient_id'];
        $data['init_patient_id']    =   $patient_id;
		//$data['clinic_info']      = $this->mbio->get_clinic_info($this->session->userdata('location_id'));
		$data['patient_info']       = $this->memr_rdb->get_patient_demo($data['patient_id']);
		...
		if ($this->form_validation->run('edit_antenatal_postpartum') == FALSE){
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_banner =   "ehr/banner_ehr_ovrvw_wap";
                $new_sidebar=   "ehr/sidebar_ehr_patients_ovrvw_wap";
                $new_body   =   "ehr_indv_edit_his_antenatal_postpartum_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['antenatal_postpartum_id'] == "new_postpartum") {
                ...
                $ins_postpartum_array['staff_id']         = $this->session->userdata('staff_id');
                ...
                $upd_postpartum_array['staff_id']           = $this->session->userdata('staff_id');
