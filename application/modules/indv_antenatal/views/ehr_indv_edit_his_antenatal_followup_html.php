...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('patients_edit_his_antenatal_followup_html_title')."</h1></div>";
...
if(isset($followup_list)){
    ...
    foreach ($followup_list as $followup_item){
        echo "\n<tr>";
        echo "\n<td>".$rownum.".</td>";
        echo "\n<td>".anchor('indv/indv/index/indv_antenatal/ehr_individual_antenatal/edit_history_antenatal/edit_history/'.$patient_id.'/'.$followup_item['antenatal_id'], "<strong>".$followup_item['date']."</strong>")."</td>";
...
echo form_open('indv/indv/index/indv_antenatal/ehr_individual_antenatal/edit_history_antenatal_followup/'.$form_purpose.'/'.$patient_id.'/'.$antenatal_id.'/'.$antenatal_followup_id, $attributes);
echo "\n<table>";
echo "\n<tr><td>Pregnancy duration <font color='red'>*</font></td><td>";
echo form_error('pregnancy_duration');
echo "\n<input type='text' name='pregnancy_duration' value='".set_value('pregnancy_duration',$init_pregnancy_duration)."' size='10' /> weeks</td></tr>";
/*
echo "\n<tr><td valign='top'>Lie</td><td>";
echo form_error('lie');
echo "\n<textarea class='normal' name='lie' id='lie' cols='40' rows='4'>".$init_lie."</textarea>";
echo "\n</td></tr>";
//echo "<input type='text' name='lie' value='".set_value('lie',$init_lie)."' size='80' /></td></tr>";
*/
echo "\n<tr><td>Weight</td><td>";
...
echo "\n<tr><td>Ankle odema</td><td>";
echo form_error('ankle_odema');
echo "<input type='text' name='ankle_odema' value='".set_value('ankle_odema',$init_ankle_odema)."' size='5' /></td></tr>";

echo "\n<tr><td valign='top'>Notes <font color='red'>*</font></td><td>";
echo form_error('notes');
echo "\n<textarea class='normal' name='notes' id='notes' cols='40' rows='4'>".$init_notes."</textarea>";
echo "\n</td>";
echo "\n</tr>";
//echo "<input type='text' name='notes' value='".set_value('notes',$init_notes)."' size='80' /></td></tr>";
*/
echo "\n<tr><td>Next followup <font color='red'>*</font></td><td>";
echo form_error('next_followup');
echo "<input type='text' name='next_followup' value='".set_value('next_followup',$init_next_followup)."' size='10' /> YYYY-MM-DD</td></tr>";

echo "\n<tr><td>Record Date</td><td>";
echo form_error('record_date');
echo "\n<input type='text' name='record_date' value='".set_value('record_date',$init_record_date)."' size='10' /> YYYY-MM-DD</td></tr>";
...
echo "\n<tr><td>Husband's birth date</td><td>";
...
echo "\n<tr><td>Planned delivery place</td><td>";
