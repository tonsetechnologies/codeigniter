...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('patients_edit_prediagnosis_html_title')."</h1></div>";
...
if(count($diagnosis_list) > 0){
    foreach ($diagnosis_list as $diagnosis_item){
        echo "\n<tr>";
        echo "<td>".anchor('cons/cons/index/cons_diagnosis/ehr_consult_diagnosis/edit_prediagnosis/edit_diagnosis/'.$patient_id.'/'.$summary_id.'/'.$diagnosis_item['diagnosis_id'], $diagnosis_item['dcode1ext_code'])."</td>";
        ...
        $delete_link    =   base_url()."index.php/ons/cons/index/cons_diagnosis/ehr_consult_diagnosis/consult_delete_diagnosis/delete_diagnosis/".$patient_id."/".$summary_id."/".$diagnosis_item['diagnosis_id'];
...
echo form_open('cons/cons/index/cons_diagnosis/ehr_consult_diagnosis/edit_prediagnosis/edit_diagnosis/'.$patient_id, $attributes);
...
echo "<tr><td><b>Observations</b></td></tr>";
echo "</table>";
echo "\n<table class='frame' width='100%' align='center'>";
echo form_hidden('diagnosisChapter', $diagnosisChapter);
/*
echo "<tr>";
...
echo "</tr>";
*/
echo form_hidden('diagnosisCategory', $diagnosisCategory);
/*
echo "\n<tr>";
...
echo "\n<tr>";
    ...
    echo form_error('diagnosis_type');
        echo "<select class='normal' name='diagnosis_type'>";          
            echo "\n<option value='Pre-diagnostic' ".set_select('diagnosis_type','Pre-diagnostic').">Pre-diagnostic</option>";
...
echo "\n</tr>";
echo "\n<tr>";
    echo "\n<td width='25%'>Further Elaboration on Observation <font color='red'>*</font></td>";
    echo "\n<td>";
...
echo "\n<br />";
echo "\n<center>";
    echo "\n<input class='button' type='submit' name='submit' value='Enter Observation' />";
echo "\n</center>";
