 ...
 * 1.1 (the "License"); you may not use this file except in compliance withcontact_id
...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('orders_edit_labsupplier_info_html_title')."</h1></div>";

echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";


$attributes =   array('class' => 'select_form', 'id' => 'consultation_form');
echo form_open('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_labsupplier_info/'.$form_purpose.'/lab/'.$supplier_id, $attributes);
...
echo "\n<input type='hidden' name='contact_id' value='".$init_contact_id."' />";
echo "\n<input type='hidden' name='customer_info_id' value='".$init_customer_info_id."' />";
...
if($form_purpose == "edit_supplier"){
    echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_package/new_package/'.$supplier_id.'/new_package', '<strong>Add Package</strong>');
}
...
foreach ($packages_list as $packages_item){
    echo "<tr>";
    echo "<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_package/edit_package/'.$supplier_id.'/'.$packages_item['lab_package_id'], $packages_item['package_name'])."</td>";
    echo "<td>".$packages_item['package_code']."</td>";
    ...
    echo "<td>".$packages_item['package_remarks']."</td>";
    echo "</tr>";
}//endforeach;
echo "</table>";
echo "\n</fieldset>";
