...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('orders_list_procsuppliers_html_title')."</h1></div>";

echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";

echo "\n<fieldset>";
echo "<legend>SUPPLIERS LIST</legend>";
echo anchor('ehr/ehr/index/ehr_orders/ehr_orders_procedure/orders_edit_procsupplier_info/new_supplier/proc/new_supplier', "<strong>Add New Supplier</strong>");
echo "\n<br /><br />";
...
if(isset($supplier_list)){
    ...
    foreach ($supplier_list as $supplier_item){
        ...
        echo "\n<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders_procedure/orders_edit_procsupplier_info/edit_supplier/proc/'.$supplier_item['supplier_id'], "<strong>".$supplier_item['supplier_name']."</strong>")."</td>";
