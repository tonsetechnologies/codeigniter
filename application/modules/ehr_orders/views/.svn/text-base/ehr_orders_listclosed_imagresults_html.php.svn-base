...
echo "<legend>CLOSED RESULTS LIST</legend>";
        ...
        foreach ($pending_imaging as $order_item){
            echo "\n<tr>";
            echo "<td>";
            echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/print_imag_result/html/'.$order_item['patient_id'].'/'.$order_item['order_id'], 'html', "target='_blank'");
            echo " ";
            echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/print_imag_result/pdf/'.$order_item['patient_id'].'/'.$order_item['order_id'], 'pdf', "target='_blank'");
            echo "</td>";
