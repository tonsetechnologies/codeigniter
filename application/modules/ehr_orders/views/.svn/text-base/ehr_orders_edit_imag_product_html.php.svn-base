...
echo form_open('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_imag_product/'.$form_purpose.'/imag/'.$supplier_id.'/'.$product_id, $attributes);
...
echo "\n<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_imagsupplier_info/edit_supplier/imag/'.$supplier_id, "<strong>".$supplier_info[0]['supplier_name']."</strong>")."</td>";
echo "</td></tr>";
