...
echo "\n\n<div id='page_title' align='center'><h1>".$this->lang->line('orders_list_imagsuppliers_html_title')."</h1></div>";

echo "\n<div class='flashdata'>".$this->session->flashdata('data_activity')."</div>";

echo "\n<fieldset>";
echo "<legend>SUPPLIERS LIST</legend>";
echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_imagsupplier_info/new_supplier/imag/new_supplier', "<strong>Add New Supplier</strong>");
echo "\n<br /><br />";
...
if(isset($supplier_list)){
    ...
    foreach ($supplier_list as $supplier_item){
        ...
        echo "\n<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_imagsupplier_info/edit_supplier/imag/'.$supplier_item['supplier_id'], "<strong>".$supplier_item['supplier_name']."</strong>")."</td>";
