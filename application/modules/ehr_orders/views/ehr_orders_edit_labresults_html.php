...
echo form_open('ehr/ehr/index/ehr_orders/ehr_orders/edit_labresults/edit_labresults/'.$patient_id.'/'.$summary_id.'/'.$lab_order_id, $attributes);
...
echo "\n<tr>";
    ...
    echo "<td><strong>".$patient_info['name']."</strong> [".$patient_info['birth_date']."]</td>";
echo "\n</tr>";
/*
echo "\n<tr>";
...
*/
echo "\n<tr>";
    echo "<td>Consultation Started</td>";
    echo "<td>".$patcon_info['date_started']." (".$patcon_info['time_started'].")</td>";
echo "\n</tr>";
/*
echo "\n<tr>";
...
echo "\n<tr><td>Results Date <font color='red'>*</font></td><td>";
echo form_error('result_date');
echo "\n<input type='text' id='result_date' name='result_date' value='".set_value('result_date',$result_date)."' size='10' /> YYYY-MM-DD</td></tr>";
...
echo "\n<input type='hidden' name='close_order' value='' />";
