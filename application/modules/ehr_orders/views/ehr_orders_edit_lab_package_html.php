...
echo form_open('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_package/'.$form_purpose.'/'.$supplier_id.'/'.$lab_package_id, $attributes);
...
echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_labsupplier_info/edit_supplier/lab/'.$supplier_id.'/'.$lab_package_id, "<strong>".$supplier_info[0]['supplier_name']."</strong>");
...
if($form_purpose == "edit_package" && (count($packages_ordered)==0)){
    echo anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_packagetest/new_packagetest/'.$lab_package_id.'/new_packagetest', '<strong>Add New Test</strong>');
...
if(isset($tests_info)){
    foreach ($tests_info as $tests_item){
        ...
        echo "<td>".anchor('ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_packagetest/edit_packagetest/'.$lab_package_id.'/'.$tests_item['lab_package_test_id'], $tests_item['test_name'])."</td>";
        ...
        if(count($packages_ordered)== 0){
            ...
            $delete_link    =   base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/orders_delete_lab_packagetest/".$supplier_id."/".$lab_package_id."/".$tests_item['lab_package_test_id'];
