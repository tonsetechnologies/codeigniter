 ...
 */
class Ehr_orders extends MX_Controller 
{
    ...
    function orders_mgt($id=NULL)  // template for new classes
    {
		...
		$data['pending_procedures'] = $this->morders_rdb->get_list_procedure_result("Pending");
		$this->load->vars($data);
    ...
    function edit_labresults($seg3,$seg4,$seg5,$seg6)
    {
		...
		if ($this->form_validation->run('edit_lab_result') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_orders_edit_labresults_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function orders_listclosed_labresults($seg3)  // List suppliers for labs
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_orders_listclosed_labresults_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function print_lab_result($seg3,$seg4,$seg5)  // Print lab result to HTML or PDF
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		$data['now_id']             =   time();
        $data['patient_id']         =   $seg3; //$this->uri->segment(3);
        $data['summary_id']         =   $seg4; //$this->uri->segment(4);
        $data['lab_order_id']       =   $seg5; //$this->uri->segment(5);
		$data['patient_info']   = $this->memr_rdb->get_patient_demo($data['patient_id']);
        $data['patcon_info']    = $this->memr_rdb->get_patcon_details($data['patient_id'],$data['summary_id']);
        $data['order_info'] = $this->memr_rdb->get_patcon_lab($data['summary_id'],$data['lab_order_id']);
        $data['package_info']  = $this->morders_lab_rdb->get_one_lab_orderresult($data['lab_order_id']);
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_print_lab_result_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function ehr_orders_list_labsuppliers($seg3)  // List suppliers for labs
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_orders_list_labsuppliers_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function orders_edit_labsupplier_info($seg3,$seg4,$seg5)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		...
		if ($this->form_validation->run('edit_labsupplier') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_orders_edit_labsupplier_info_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_supplier") {
                ...
                $this->session->set_flashdata('data_activity', 'Lab supplier added.');
            } elseif($data['form_purpose'] == "edit_supplier") {
                ...
                $this->session->set_flashdata('data_activity', 'Lab supplier updated.');
            } //endif($data['diagnosis_id'] == "new_supplier")
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/ehr_orders_list_labsuppliers/lab";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function orders_edit_lab_package($seg3,$seg4,$seg5)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['app_currency']		=	$this->config->item('app_currency');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['form_purpose']       =   $seg3; //$this->uri->segment(3);
        $data['supplier_id']        =   $seg4; //$this->uri->segment(4);
        $data['lab_package_id']     =   $seg5; //$this->uri->segment(5);
        ...
        if(count($_POST)) {
            ...
            if ($data['form_purpose'] == "new_package") {
				...
				$data['tests_info']         = $this->morders_lab_rdb->get_one_lab_package_test($data['lab_package_id']);
		...
		if ($this->form_validation->run('edit_lab_package') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_orders_edit_lab_package_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_package") {
                ...
                $ins_package_array['staff_id']        = $this->session->userdata('staff_id');
                ...
                $upd_package_array['staff_id']       = $this->session->userdata('staff_id');
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_labsupplier_info/edit_supplier/lab/".$data['supplier_id'];
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    // ------------------------------------------------------------------------
    function orders_delete_lab_packagetest($seg3,$seg4,$seg5) 
    {
		...
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        $data['breadcrumbs']        =   breadcrumbs('ehr_orders/orders_mgt','Orders','ehr_orders/ehr_orders_list_labsuppliers/lab','List Lab Suppliers');    
        $data['supplier_id']        =   $seg3; //$this->uri->segment(3);
        $data['lab_package_id']     =   $seg4; //$this->uri->segment(4);
        $data['lab_package_test_id'] =   $seg5; //$this->uri->segment(5);
        ...
        $new_page = base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_lab_package/edit_package/".$data['supplier_id']."/".$data['lab_package_id'];
        header("Status: 200");
        header("Location: ".$new_page);
    ...
    function orders_edit_lab_packagetest($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
		...
		if ($this->form_validation->run('edit_lab_packagetest') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_orders_edit_lab_packagetest_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            if($data['form_purpose'] == "new_packagetest") {
                ...
                $ins_test_array['location_id']      = $this->session->userdata('location_id');
               ...
               $ins_lab_array['lab_package_test_id']    = $data['lab_package_test_id'];
                $ins_lab_array['staff_id']        = $this->session->userdata('staff_id');
                $ins_lab_array['lab_package_id']  = $data['lab_package_id'];
                //$ins_lab_array['location_id']  = $this->session->userdata('location_id');
    ...
    // ------------------------------------------------------------------------
    function ehr_orders_list_imagsuppliers($seg3)  // List suppliers for imaging
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
		$data['user_rights']        =   $this->mthirra->get_user_rights($this->session->userdata('username'));
        ...
        if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
            ...
            $new_body   =   "ehr_orders_list_imagsuppliers_html";
            $new_footer =   "ehr/footer_emr_wap";
		} else {
            //$new_header =   "ehr/header_xhtml1-strict";
            $new_header =   "ehr/header_xhtml1-transitional";
    ...
    // ------------------------------------------------------------------------
    function orders_edit_imagsupplier_info($seg3,$seg4,$seg5)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['app_currency']		=	$this->config->item('app_currency');
		...
		if ($this->form_validation->run('edit_imagsupplier') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_body   =   "ehr_orders_edit_imagsupplier_info_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/ehr_orders_list_imagsuppliers";
            header("Status: 200");
            header("Location: ".$new_page);
    ...
    function orders_edit_imag_product($seg3,$seg4,$seg5,$seg6)
    {
        $data['offline_mode']		=	$this->config->item('offline_mode');
        $data['debug_mode']		    =	$this->config->item('debug_mode');
        $data['app_currency']		=	$this->config->item('app_currency');
		...
		if ($this->form_validation->run('edit_imag_product') == FALSE){
            ...
            if ($this->session->userdata('thirra_mode') == "ehr_mobile"){
                ...
                $new_sidebar=   "ehr/sidebar_ehr_orders_wap";
                //$new_body   =   "ehr/ehr_orders_edit_lab_packagetest_wap";
                $new_body   =   "ehr_orders_edit_imag_product_html";
                $new_footer =   "ehr/footer_emr_wap";
            } else {
                //$new_header =   "ehr/header_xhtml1-strict";
                $new_header =   "ehr/header_xhtml1-transitional";
            ...
            $new_page = base_url()."index.php/ehr/ehr/index/ehr_orders/ehr_orders/orders_edit_imagsupplier_info/edit_supplier/imag/".$data['supplier_id'];
            header("Status: 200");
            header("Location: ".$new_page);
